...
Usage:
  python3 vis_register_keygen.py 500 1 A
  python3 vis_register_keygen.py 500 2 C
...
def main():
    ...
    parser.add_argument("vendor_id", type=int)
    parser.add_argument("product_id", type=int)
    parser.add_argument("license_class", choices=["A", "B", "C", "a", "b", "c"])
    args = parser.parse_args()
    print(generate_key(args.vendor_id, args.product_id, args.license_class))
