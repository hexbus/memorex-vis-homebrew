# Commented Disassembly - Mitsumi embedded CDROM driver

# 00 ed067 ed2ff header strings early data
...
Embedded command line, DOS header, early data/code region.

## Local labels and strings

```text
0xED067  embedded_cmdline: Embedded command line: cd.sys /m:18 /i:5 /t:5 /d:mscd001 /h
0xED08D  dos_device_header: DOS device-driver header for embedded Mitsumi/Gryphon CD-ROM driver
0xED067  string[37]: cd.sys /m:18 /i:5 /t:5 /d:mscd001 /h\r
0xED0A7  string[70]: Copyright (C) Mitsumi corporation 1989,1990,1991. All right reserved  
```
...
; ---------------------------------------------------------------------------
; embedded_cmdline @ 0xED067
; Embedded command line: cd.sys /m:18 /i:5 /t:5 /d:mscd001 /h
; ---------------------------------------------------------------------------

; STRING @ 0xED067, length 37: cd.sys /m:18 /i:5 /t:5 /d:mscd001 /h\r
   ed067:	63 64 2e             	arpl   %sp,0x2e(%si)
   ed06a:	73 79                	jae    0xed0e5    ; driver var 00EDh: transfer progress counter A
   ed06c:	73 20                	jae    0xed08e    ; driver var 00EDh: transfer progress counter A
   ed06e:	2f                   	das
   ed06f:	6d                   	insw   (%dx),%es:(%di)    ; Hardware/port read
   ed070:	3a 31                	cmp    (%bx,%di),%dh
   ed072:	38 20                	cmp    %ah,(%bx,%si)
   ed074:	2f                   	das
   ed075:	69 3a 35 20          	imul   $0x2035,(%bp,%si),%di    ; Mitsumi command 20h: sub-Q candidate
   ed079:	2f                   	das
   ed07a:	74 3a                	je     0xed0b6    ; driver var 00EDh: transfer progress counter A
...
; ---------------------------------------------------------------------------
; dos_device_header @ 0xED08D
; DOS device-driver header for embedded Mitsumi/Gryphon CD-ROM driver
; ---------------------------------------------------------------------------
   ed08d:	ff                   	(bad)
   ed08e:	ff                   	(bad)
   ed08f:	ff                   	(bad)
   ...
   ed0a9:	70 79                	jo     0xed124    ; driver var 00EDh: transfer progress counter A
   ed0ab:	72 69                	jb     0xed116    ; driver var 00EDh: transfer progress counter A
   ed0ad:	67 68 74 20          	addr32 push $0x2074    ; Mitsumi command 20h: sub-Q candidate
   ed0b1:	28 43 29             	sub    %al,0x29(%bp,%di)
   ed0b4:	20 4d 69             	and    %cl,0x69(%di)    ; driver var 0069h: MSF minute
   ed0b7:	74 73                	je     0xed12c    ; driver var 00EDh: transfer progress counter A
   ed0b9:	75 6d                	jne    0xed128    ; driver var 00EDh: transfer progress counter A
   ed0bb:	69 20 63 6f          	imul   $0x6f63,(%bx,%si),%sp
   ed0bf:	72 70                	jb     0xed131    ; driver var 00EDh: transfer progress counter A
   ed0c1:	6f                   	outsw  %ds:(%si),(%dx)
   ed0c2:	72 61                	jb     0xed125    ; driver var 00EDh: transfer progress counter A
   ed0c4:	74 69                	je     0xed12f    ; driver var 00EDh: transfer progress counter A
   ...
   ed0da:	6c                   	insb   (%dx),%es:(%di)    ; Hardware/port read
   ed0db:	6c                   	insb   (%dx),%es:(%di)    ; Hardware/port read
   ed0dc:	20 72 69             	and    %dh,0x69(%bp,%si)    ; driver var 0069h: MSF minute
   ed0df:	67 68 74 20          	addr32 push $0x2074    ; Mitsumi command 20h: sub-Q candidate
   ed0e3:	72 65                	jb     0xed14a    ; driver var 00EDh: transfer progress counter A
   ed0e5:	73 65                	jae    0xed14c    ; driver var 00EDh: transfer progress counter A
   ed0e7:	72 76                	jb     0xed15f    ; driver var 00EDh: transfer progress counter A
...
```
# 01 ed300 ed7ff early driver body
...
Early driver body and tables.

## Local labels and strings

```text
No named labels or printable strings detected in this range yet.
```
...
```asm
   ...
   ed54c:	05 07 04             	add    $0x407,%ax    ; Mitsumi command 40h: status
   ed54f:	02 06 07 00          	add    0x7,%al
   ed553:	01 02                	add    %ax,(%bp,%si)
   ed555:	03 04                	add    (%si),%ax
   ed557:	05 06 07             	add    $0x706,%ax    ; Mitsumi command 70h: hold/pause
   ...
   ed5fc:	ed                   	in     (%dx),%ax    ; Hardware/port read
...
```
# 02 ed800 edcff strategy dispatch open close
...
Strategy/interrupt entry, dispatcher, open/close and IOCTL region.

## Local labels and strings

```text
0xEDA18  strategy_entry: DOS device-driver strategy entry. Stores ES:BX request-header pointer.
0xEDA23  interrupt_entry_dispatcher: DOS device-driver interrupt entry. Reads request command and dispatches.
0xEDB8C  device_open_close_handler: Common DEVICE OPEN / DEVICE CLOSE style completion path.
0xEDBD0  ioctl_output_handler: IOCTL OUTPUT request handler and secondary dispatch entry.
0xEDA24  string[7]: PSQRVWU
0xEDAC4  string[7]: ]_^ZY[X
```
...
; ---------------------------------------------------------------------------
; strategy_entry @ 0xEDA18
; DOS device-driver strategy entry. Stores ES:BX request-header pointer.
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
; interrupt_entry_dispatcher @ 0xEDA23
; DOS device-driver interrupt entry. Reads request command and dispatches.
; ---------------------------------------------------------------------------
   eda23:	9c                   	pushf

; STRING @ 0xEDA24, length 7: PSQRVWU
   eda24:	50                   	push   %ax
   eda25:	53                   	push   %bx
   eda26:	51                   	push   %cx
   eda27:	52                   	push   %dx
   ...
   eda57:	75 0f                	jne    0xeda68    ; driver var 00EDh: transfer progress counter A
   eda59:	8a 26 a7 03          	mov    0x3a7,%ah
   eda5d:	80 fc 01             	cmp    $0x1,%ah
   eda60:	74 23                	je     0xeda85    ; driver var 00EDh: transfer progress counter A
   eda62:	fe c4                	inc    %ah
   eda64:	88 26 a7 03          	mov    %ah,0x3a7
   eda68:	be 19 05             	mov    $0x519,%si
   eda6b:	b1 10                	mov    $0x10,%cl    ; Mitsumi command 10h: TOC/disk info candidate
   eda6d:	3c 80                	cmp    $0x80,%al
   eda6f:	72 07                	jb     0xeda78    ; driver var 00EDh: transfer progress counter A
   eda71:	be 39 05             	mov    $0x539,%si
   eda74:	b1 09                	mov    $0x9,%cl
   eda76:	2c 80                	sub    $0x80,%al
   eda78:	3a c1                	cmp    %cl,%al
   eda7a:	72 02                	jb     0xeda7e    ; driver var 00EDh: transfer progress counter A
   eda7c:	eb 07                	jmp    0xeda85    ; driver var 00EDh: transfer progress counter A
   eda7e:	98                   	cbtw
   eda7f:	d1 e0                	shl    $1,%ax
   eda81:	03 f0                	add    %ax,%si
   eda83:	ff 24                	jmp    *(%si)
   eda85:	b8 03 80             	mov    $0x8003,%ax
   eda88:	eb 03                	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   eda8a:	0d 00 02             	or     $0x200,%ax    ; Mitsumi command 20h: sub-Q candidate
   eda8d:	0d 00 01             	or     $0x100,%ax    ; Mitsumi command 10h: TOC/disk info candidate
   eda90:	2e 80 3e 00 05 00    	cmpb   $0x0,%cs:0x500    ; driver var 0500h: transfer loop flag
   eda96:	74 09                	je     0xedaa1    ; driver var 00EDh: transfer progress counter A
   eda98:	2e c6 06 00 05 00    	movb   $0x0,%cs:0x500    ; driver var 0500h: transfer loop flag
   eda9e:	25 f0 7f             	and    $0x7ff0,%ax
   edaa1:	80 3e b0 03 00       	cmpb   $0x0,0x3b0
   edaa6:	74 01                	je     0xedaa9    ; driver var 00EDh: transfer progress counter A
   edaa8:	90                   	nop
...
; STRING @ 0xEDAC4, length 7: ]_^ZY[X
   edac4:	5d                   	pop    %bp
   edac5:	5f                   	pop    %di
   edac6:	5e                   	pop    %si
   edac7:	5a                   	pop    %dx
   ...
   edad7:	75 02                	jne    0xedadb    ; driver var 00EDh: transfer progress counter A
   edad9:	eb b2                	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   edadb:	eb ad                	jmp    0xeda8a    ; driver var 00EDh: transfer progress counter A
   edadd:	33 c0                	xor    %ax,%ax
   edadf:	c6 06 f8 00 01       	movb   $0x1,0xf8
   edae4:	e8 3a 15             	call   0xef021    ; driver var 00EFh: transfer progress counter B
   edae7:	3c 00                	cmp    $0x0,%al
   edae9:	74 03                	je     0xedaee    ; driver var 00EDh: transfer progress counter A
   edaeb:	b0 ff                	mov    $0xff,%al
   edaed:	c3                   	ret
   edaee:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   edaf3:	e8 e7 2d             	call   0xe08dd
   edaf6:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   edafa:	b0 dc                	mov    $0xdc,%al    ; Mitsumi command DCh: version
   edafc:	ee                   	out    %al,(%dx)    ; OUT command byte DCh via [0061] path: version | Hardware/port write
   edafd:	eb 00                	jmp    0xedaff    ; driver var 00EDh: transfer progress counter A
   edaff:	e8 4a 2e             	call   0xe094c
   edb02:	3c ff                	cmp    $0xff,%al
   edb04:	75 0a                	jne    0xedb10    ; driver var 00EDh: transfer progress counter A
   edb06:	fe 0e c8 03          	decb   0x3c8
   edb0a:	75 e7                	jne    0xedaf3    ; driver var 00EDh: transfer progress counter A
   edb0c:	e8 d4 01             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   edb0f:	c3                   	ret
   edb10:	88 1e 06 01          	mov    %bl,0x106
   edb14:	f6 c3 01             	test   $0x1,%bl
   edb17:	74 03                	je     0xedb1c    ; driver var 00EDh: transfer progress counter A
   edb19:	b0 04                	mov    $0x4,%al
   edb1b:	c3                   	ret
   edb1c:	e8 2d 2e             	call   0xe094c
   edb1f:	3c ff                	cmp    $0xff,%al
   edb21:	75 0a                	jne    0xedb2d    ; driver var 00EDh: transfer progress counter A
   edb23:	fe 0e c8 03          	decb   0x3c8
   edb27:	75 ca                	jne    0xedaf3    ; driver var 00EDh: transfer progress counter A
   edb29:	e8 b7 01             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   edb2c:	c3                   	ret
   edb2d:	88 1e be 03          	mov    %bl,0x3be
   edb31:	e8 18 2e             	call   0xe094c
   edb34:	3c ff                	cmp    $0xff,%al
   edb36:	75 0a                	jne    0xedb42    ; driver var 00EDh: transfer progress counter A
   edb38:	fe 0e c8 03          	decb   0x3c8
   edb3c:	75 b5                	jne    0xedaf3    ; driver var 00EDh: transfer progress counter A
   edb3e:	e8 a2 01             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   edb41:	c3                   	ret
   edb42:	88 1e bf 03          	mov    %bl,0x3bf
   edb46:	a0 06 01             	mov    0x106,%al
   edb49:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   edb4b:	75 0a                	jne    0xedb57    ; driver var 00EDh: transfer progress counter A
   edb4d:	a8 80                	test   $0x80,%al
   edb4f:	75 03                	jne    0xedb54    ; driver var 00EDh: transfer progress counter A
   edb51:	b0 02                	mov    $0x2,%al
   edb53:	c3                   	ret
   edb54:	b0 03                	mov    $0x3,%al
   edb56:	c3                   	ret
   edb57:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   edb59:	74 0f                	je     0xedb6a    ; driver var 00EDh: transfer progress counter A
   edb5b:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   edb60:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   edb65:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   edb6a:	a8 02                	test   $0x2,%al
   edb6c:	74 03                	je     0xedb71    ; driver var 00EDh: transfer progress counter A
   edb6e:	b0 01                	mov    $0x1,%al
   edb70:	c3                   	ret
   edb71:	33 c0                	xor    %ax,%ax
   edb73:	c3                   	ret
   edb74:	c6 06 c0 03 00       	movb   $0x0,0x3c0
   edb79:	e8 85 1a             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   edb7c:	3c 01                	cmp    $0x1,%al
   edb7e:	74 06                	je     0xedb86    ; driver var 00EDh: transfer progress counter A
   edb80:	b8 03 80             	mov    $0x8003,%ax
   edb83:	e9 07 ff             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   edb86:	b8 03 80             	mov    $0x8003,%ax
   edb89:	e9 fe fe             	jmp    0xeda8a    ; driver var 00EDh: transfer progress counter A

; ---------------------------------------------------------------------------
; device_open_close_handler @ 0xEDB8C
; Common DEVICE OPEN / DEVICE CLOSE style completion path.
; ---------------------------------------------------------------------------
   edb8c:	e8 01 23             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   edb8f:	3c 01                	cmp    $0x1,%al
   edb91:	74 02                	je     0xedb95    ; driver var 00EDh: transfer progress counter A
   edb93:	eb 07                	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   edb95:	e8 69 1a             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   edb98:	3c 01                	cmp    $0x1,%al
   edb9a:	74 05                	je     0xedba1    ; driver var 00EDh: transfer progress counter A
   edb9c:	33 c0                	xor    %ax,%ax
   edb9e:	e9 ec fe             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   edba1:	33 c0                	xor    %ax,%ax
   edba3:	e9 e4 fe             	jmp    0xeda8a    ; driver var 00EDh: transfer progress counter A
   edba6:	e8 e7 22             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   edba9:	3c 01                	cmp    $0x1,%al
   edbab:	74 02                	je     0xedbaf    ; driver var 00EDh: transfer progress counter A
   edbad:	eb 1d                	jmp    0xedbcc    ; driver var 00EDh: transfer progress counter A
   edbaf:	c6 06 c0 03 00       	movb   $0x0,0x3c0
   edbb4:	c6 06 f8 00 00       	movb   $0x0,0xf8
   edbb9:	c7 06 ed 00 00 00    	movw   $0x0,0xed    ; driver var 00EDh: transfer progress counter A
   edbbf:	c7 06 ef 00 00 00    	movw   $0x0,0xef    ; driver var 00EFh: transfer progress counter B
   edbc5:	e8 39 1a             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   edbc8:	3c 01                	cmp    $0x1,%al
   edbca:	74 02                	je     0xedbce    ; driver var 00EDh: transfer progress counter A
   edbcc:	eb ce                	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   edbce:	eb d1                	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A

; ---------------------------------------------------------------------------
; ioctl_output_handler @ 0xEDBD0
; IOCTL OUTPUT request handler and secondary dispatch entry.
; ---------------------------------------------------------------------------
   ...
   edbe1:	76 0d                	jbe    0xedbf0    ; driver var 00EDh: transfer progress counter A
   edbe3:	3c fe                	cmp    $0xfe,%al    ; Mitsumi command FEh: lock/unlock
   edbe5:	75 03                	jne    0xedbea    ; driver var 00EDh: transfer progress counter A
   edbe7:	e9 55 03             	jmp    0xedf3f    ; driver var 00EDh: transfer progress counter A
   edbea:	b8 03 80             	mov    $0x8003,%ax
   edbed:	e9 9d fe             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   edbf0:	d1 e0                	shl    $1,%ax
   edbf2:	03 f0                	add    %ax,%si
   edbf4:	ff 24                	jmp    *(%si)
   edbf6:	c6 06 c0 03 00       	movb   $0x0,0x3c0
   edbfb:	33 c0                	xor    %ax,%ax
   edbfd:	e8 dd fe             	call   0xedadd    ; driver var 00EDh: transfer progress counter A
   edc00:	3c ff                	cmp    $0xff,%al
   edc02:	75 03                	jne    0xedc07    ; driver var 00EDh: transfer progress counter A
   edc04:	e9 16 05             	jmp    0xee11d
   edc07:	3c 04                	cmp    $0x4,%al
   edc09:	75 03                	jne    0xedc0e    ; driver var 00EDh: transfer progress counter A
   edc0b:	e9 bf fe             	jmp    0xedacd    ; driver var 00EDh: transfer progress counter A
   edc0e:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   edc13:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   edc17:	b0 f6                	mov    $0xf6,%al    ; Mitsumi command F6h: eject
   edc19:	ee                   	out    %al,(%dx)    ; OUT command byte F6h via [0061] path: eject | Hardware/port write
   edc1a:	eb 00                	jmp    0xedc1c    ; driver var 00EDh: transfer progress counter A
   edc1c:	e8 e2 19             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   edc1f:	3c ff                	cmp    $0xff,%al
   edc21:	75 0c                	jne    0xedc2f    ; driver var 00EDh: transfer progress counter A
   edc23:	fe 0e c8 03          	decb   0x3c8
   edc27:	75 ea                	jne    0xedc13    ; driver var 00EDh: transfer progress counter A
   edc29:	e8 b7 00             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   edc2c:	e9 ee 04             	jmp    0xee11d
   edc2f:	88 1e 06 01          	mov    %bl,0x106
   edc33:	f6 c3 01             	test   $0x1,%bl
   edc36:	74 03                	je     0xedc3b    ; driver var 00EDh: transfer progress counter A
   edc38:	e9 92 fe             	jmp    0xedacd    ; driver var 00EDh: transfer progress counter A
   edc3b:	e9 5e ff             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   edc3e:	c6 06 c0 03 00       	movb   $0x0,0x3c0
   edc43:	33 c0                	xor    %ax,%ax
   edc45:	e8 95 fe             	call   0xedadd    ; driver var 00EDh: transfer progress counter A
   edc48:	3c ff                	cmp    $0xff,%al
   edc4a:	75 03                	jne    0xedc4f    ; driver var 00EDh: transfer progress counter A
   edc4c:	e9 ce 04             	jmp    0xee11d
   edc4f:	3c 04                	cmp    $0x4,%al
   edc51:	75 03                	jne    0xedc56    ; driver var 00EDh: transfer progress counter A
   edc53:	e9 77 fe             	jmp    0xedacd    ; driver var 00EDh: transfer progress counter A
   edc56:	26 8a 05             	mov    %es:(%di),%al
   edc59:	a2 bd 03             	mov    %al,0x3bd
   edc5c:	3c 01                	cmp    $0x1,%al
   edc5e:	74 0c                	je     0xedc6c    ; driver var 00EDh: transfer progress counter A
   edc60:	3c 00                	cmp    $0x0,%al
   edc62:	74 08                	je     0xedc6c    ; driver var 00EDh: transfer progress counter A
   edc64:	c6 06 bd 03 00       	movb   $0x0,0x3bd
   edc69:	e9 61 fe             	jmp    0xedacd    ; driver var 00EDh: transfer progress counter A
   edc6c:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   edc71:	e8 3d 00             	call   0xedcb1    ; driver var 00EDh: transfer progress counter A
   edc74:	3c ff                	cmp    $0xff,%al
   edc76:	75 0c                	jne    0xedc84    ; driver var 00EDh: transfer progress counter A
   edc78:	fe 0e c8 03          	decb   0x3c8
   edc7c:	75 f3                	jne    0xedc71    ; driver var 00EDh: transfer progress counter A
   edc7e:	e8 62 00             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   edc81:	e9 99 04             	jmp    0xee11d
   edc84:	88 1e 06 01          	mov    %bl,0x106
   edc88:	f6 c3 01             	test   $0x1,%bl
   edc8b:	74 03                	je     0xedc90    ; driver var 00EDh: transfer progress counter A
   edc8d:	e9 3d fe             	jmp    0xedacd    ; driver var 00EDh: transfer progress counter A
   edc90:	f6 c3 20             	test   $0x20,%bl    ; Mitsumi command 20h: sub-Q candidate
   edc93:	74 0f                	je     0xedca4    ; driver var 00EDh: transfer progress counter A
   edc95:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   edc9a:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   edc9f:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   edca4:	33 c0                	xor    %ax,%ax
   edca6:	f6 c3 02             	test   $0x2,%bl
   edca9:	74 03                	je     0xedcae    ; driver var 00EDh: transfer progress counter A
   edcab:	e9 dc fd             	jmp    0xeda8a    ; driver var 00EDh: transfer progress counter A
   edcae:	e9 dc fd             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   edcb1:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   edcb5:	b0 fe                	mov    $0xfe,%al    ; Mitsumi command FEh: lock/unlock
   edcb7:	9c                   	pushf
   edcb8:	fa                   	cli
   edcb9:	ee                   	out    %al,(%dx)    ; OUT command byte FEh via [0061] path: lock/unlock | Hardware/port write
   edcba:	a0 bd 03             	mov    0x3bd,%al
   edcbd:	ee                   	out    %al,(%dx)    ; Hardware/port write
   edcbe:	9d                   	popf
   ...
   edcdd:	e8 03 00             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   edce0:	e9 b9 fe             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   edce3:	50                   	push   %ax
   edce4:	33 c0                	xor    %ax,%ax
   edce6:	8b 16 65 00          	mov    0x65,%dx
   edcea:	ee                   	out    %al,(%dx)    ; Hardware/port write
   edceb:	eb 00                	jmp    0xedced    ; driver var 00EDh: transfer progress counter A
   edced:	51                   	push   %cx
   edcee:	b9 02 00             	mov    $0x2,%cx
   edcf1:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   edcf5:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   edcf7:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
   edcf8:	eb 00                	jmp    0xedcfa    ; driver var 00EDh: transfer progress counter A
   edcfa:	e8 4f 2c             	call   0xe094c
   edcfd:	3c ff                	cmp    $0xff,%al
   edcff:	75 03                	jne    0xedd04    ; driver var 00EDh: transfer progress counter A
```
# 03 edd00 ee2ff ioctl media handlers
...
IOCTL/media handlers and secondary dispatch paths.

## Local labels and strings

```text
0xEE02C  media_check_handler: MEDIA CHECK handler.
0xEE034  ioctl_input_handler: IOCTL INPUT request handler and secondary dispatch entry.
0xEDD56  string[4]: u	G&
0xEDD63  string[4]: u	G&
0xEDD85  string[4]: u	G&
0xEDD92  string[4]: u	G&
0xEDF68  string[6]: SQRVWU
0xEDF8A  string[6]: ]_^ZY[
```
...
```asm
   edd01:	49                   	dec    %cx
   edd02:	75 ed                	jne    0xedcf1    ; driver var 00EDh: transfer progress counter A
   edd04:	59                   	pop    %cx
   edd05:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   edd0a:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   edd0f:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   edd14:	e8 9a ff             	call   0xedcb1    ; driver var 00EDh: transfer progress counter A
   edd17:	e8 9d 01             	call   0xedeb7    ; driver var 00EDh: transfer progress counter A
   edd1a:	e8 c8 20             	call   0xefde5    ; driver var 00EFh: transfer progress counter B
   edd1d:	e8 48 02             	call   0xedf68    ; driver var 00EDh: transfer progress counter A
   edd20:	58                   	pop    %ax
   edd21:	c3                   	ret
   ...
   edd40:	e8 9a fd             	call   0xedadd    ; driver var 00EDh: transfer progress counter A
   edd43:	3c ff                	cmp    $0xff,%al
   edd45:	75 03                	jne    0xedd4a    ; driver var 00EDh: transfer progress counter A
   edd47:	e9 d3 03             	jmp    0xee11d
   edd4a:	3c 04                	cmp    $0x4,%al
   edd4c:	75 03                	jne    0xedd51    ; driver var 00EDh: transfer progress counter A
   edd4e:	e9 7c fd             	jmp    0xedacd    ; driver var 00EDh: transfer progress counter A
   edd51:	26 8a 05             	mov    %es:(%di),%al
   edd54:	3c 00                	cmp    $0x0,%al

; STRING @ 0xEDD56, length 4: u	G&
   edd56:	75 09                	jne    0xedd61    ; driver var 00EDh: transfer progress counter A
   edd58:	47                   	inc    %di
   edd59:	26 8a 05             	mov    %es:(%di),%al
   edd5c:	a2 b5 03             	mov    %al,0x3b5
   edd5f:	eb 1e                	jmp    0xedd7f    ; driver var 00EDh: transfer progress counter A
   edd61:	3c 01                	cmp    $0x1,%al

; STRING @ 0xEDD63, length 4: u	G&
   edd63:	75 09                	jne    0xedd6e    ; driver var 00EDh: transfer progress counter A
   edd65:	47                   	inc    %di
   edd66:	26 8a 05             	mov    %es:(%di),%al
   edd69:	a2 b8 03             	mov    %al,0x3b8
   edd6c:	eb 11                	jmp    0xedd7f    ; driver var 00EDh: transfer progress counter A
   edd6e:	3c 02                	cmp    $0x2,%al
   edd70:	75 03                	jne    0xedd75    ; driver var 00EDh: transfer progress counter A
   edd72:	e9 22 01             	jmp    0xede97    ; driver var 00EDh: transfer progress counter A
   edd75:	3c 03                	cmp    $0x3,%al
   edd77:	75 03                	jne    0xedd7c    ; driver var 00EDh: transfer progress counter A
   edd79:	e9 1b 01             	jmp    0xede97    ; driver var 00EDh: transfer progress counter A
   edd7c:	e9 98 03             	jmp    0xee117
   edd7f:	47                   	inc    %di
   edd80:	26 8a 05             	mov    %es:(%di),%al
   edd83:	3c 00                	cmp    $0x0,%al

; STRING @ 0xEDD85, length 4: u	G&
   edd85:	75 09                	jne    0xedd90    ; driver var 00EDh: transfer progress counter A
   edd87:	47                   	inc    %di
   edd88:	26 8a 05             	mov    %es:(%di),%al
   edd8b:	a2 b6 03             	mov    %al,0x3b6
   edd8e:	eb 1e                	jmp    0xeddae    ; driver var 00EDh: transfer progress counter A
   edd90:	3c 01                	cmp    $0x1,%al

; STRING @ 0xEDD92, length 4: u	G&
   edd92:	75 09                	jne    0xedd9d    ; driver var 00EDh: transfer progress counter A
   edd94:	47                   	inc    %di
   edd95:	26 8a 05             	mov    %es:(%di),%al
   edd98:	a2 b7 03             	mov    %al,0x3b7
   edd9b:	eb 11                	jmp    0xeddae    ; driver var 00EDh: transfer progress counter A
   edd9d:	3c 02                	cmp    $0x2,%al
   edd9f:	75 03                	jne    0xedda4    ; driver var 00EDh: transfer progress counter A
   edda1:	e9 f3 00             	jmp    0xede97    ; driver var 00EDh: transfer progress counter A
   edda4:	3c 03                	cmp    $0x3,%al
   edda6:	75 03                	jne    0xeddab    ; driver var 00EDh: transfer progress counter A
   edda8:	e9 ec 00             	jmp    0xede97    ; driver var 00EDh: transfer progress counter A
   eddab:	e9 69 03             	jmp    0xee117
   eddae:	80 3e f3 04 00       	cmpb   $0x0,0x4f3
   eddb3:	74 56                	je     0xede0b    ; driver var 00EDh: transfer progress counter A
   eddb5:	80 3e b5 03 00       	cmpb   $0x0,0x3b5
   eddba:	74 16                	je     0xeddd2    ; driver var 00EDh: transfer progress counter A
   eddbc:	80 3e b7 03 00       	cmpb   $0x0,0x3b7
   eddc1:	75 48                	jne    0xede0b    ; driver var 00EDh: transfer progress counter A
   eddc3:	80 3e b6 03 00       	cmpb   $0x0,0x3b6
   eddc8:	75 41                	jne    0xede0b    ; driver var 00EDh: transfer progress counter A
   eddca:	a0 b5 03             	mov    0x3b5,%al
   eddcd:	a2 b6 03             	mov    %al,0x3b6
   eddd0:	eb 39                	jmp    0xede0b    ; driver var 00EDh: transfer progress counter A
   eddd2:	80 3e b8 03 00       	cmpb   $0x0,0x3b8
   eddd7:	74 16                	je     0xeddef    ; driver var 00EDh: transfer progress counter A
   eddd9:	80 3e b7 03 00       	cmpb   $0x0,0x3b7
   eddde:	75 2b                	jne    0xede0b    ; driver var 00EDh: transfer progress counter A
   edde0:	80 3e b6 03 00       	cmpb   $0x0,0x3b6
   edde5:	75 24                	jne    0xede0b    ; driver var 00EDh: transfer progress counter A
   edde7:	a0 b8 03             	mov    0x3b8,%al
   eddea:	a2 b7 03             	mov    %al,0x3b7
   edded:	eb 1c                	jmp    0xede0b    ; driver var 00EDh: transfer progress counter A
   eddef:	80 3e b6 03 00       	cmpb   $0x0,0x3b6
   eddf4:	74 08                	je     0xeddfe    ; driver var 00EDh: transfer progress counter A
   eddf6:	a0 b6 03             	mov    0x3b6,%al
   eddf9:	a2 b5 03             	mov    %al,0x3b5
   eddfc:	eb 0d                	jmp    0xede0b    ; driver var 00EDh: transfer progress counter A
   eddfe:	80 3e b7 03 00       	cmpb   $0x0,0x3b7
   ede03:	74 06                	je     0xede0b    ; driver var 00EDh: transfer progress counter A
   ede05:	a0 b7 03             	mov    0x3b7,%al
   ede08:	a2 b8 03             	mov    %al,0x3b8
   ede0b:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ede10:	e8 ca 2a             	call   0xe08dd
   ede13:	e8 a1 00             	call   0xedeb7    ; driver var 00EDh: transfer progress counter A
   ede16:	3c ff                	cmp    $0xff,%al
   ede18:	75 0c                	jne    0xede26    ; driver var 00EDh: transfer progress counter A
   ede1a:	fe 0e c8 03          	decb   0x3c8
   ede1e:	75 f0                	jne    0xede10    ; driver var 00EDh: transfer progress counter A
   ede20:	e8 c0 fe             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ede23:	e9 f7 02             	jmp    0xee11d
   ede26:	f6 c3 01             	test   $0x1,%bl
   ede29:	74 03                	je     0xede2e    ; driver var 00EDh: transfer progress counter A
   ...
   ede3c:	75 0c                	jne    0xede4a    ; driver var 00EDh: transfer progress counter A
   ede3e:	fe 0e c8 03          	decb   0x3c8
   ede42:	75 cc                	jne    0xede10    ; driver var 00EDh: transfer progress counter A
   ede44:	e8 9c fe             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ede47:	e9 d3 02             	jmp    0xee11d
   ede4a:	88 1e b9 03          	mov    %bl,0x3b9
   ede4e:	e8 fb 2a             	call   0xe094c
   ede51:	3c ff                	cmp    $0xff,%al
   ede53:	75 0c                	jne    0xede61    ; driver var 00EDh: transfer progress counter A
   ede55:	fe 0e c8 03          	decb   0x3c8
   ede59:	75 b5                	jne    0xede10    ; driver var 00EDh: transfer progress counter A
   ede5b:	e8 85 fe             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ede5e:	e9 bc 02             	jmp    0xee11d
   ede61:	88 1e ba 03          	mov    %bl,0x3ba
   ede65:	e8 e4 2a             	call   0xe094c
   ede68:	3c ff                	cmp    $0xff,%al
   ede6a:	75 0e                	jne    0xede7a    ; driver var 00EDh: transfer progress counter A
   ede6c:	fe 0e c8 03          	decb   0x3c8
   ede70:	74 02                	je     0xede74    ; driver var 00EDh: transfer progress counter A
   ede72:	eb 9c                	jmp    0xede10    ; driver var 00EDh: transfer progress counter A
   ede74:	e8 6c fe             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ede77:	e9 a3 02             	jmp    0xee11d
   ede7a:	88 1e bb 03          	mov    %bl,0x3bb
   ede7e:	e8 cb 2a             	call   0xe094c
   ede81:	3c ff                	cmp    $0xff,%al
   ede83:	75 0e                	jne    0xede93    ; driver var 00EDh: transfer progress counter A
   ede85:	fe 0e c8 03          	decb   0x3c8
   ede89:	74 02                	je     0xede8d    ; driver var 00EDh: transfer progress counter A
   ede8b:	eb 83                	jmp    0xede10    ; driver var 00EDh: transfer progress counter A
   ede8d:	e8 53 fe             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ede90:	e9 8a 02             	jmp    0xee11d
   ede93:	88 1e bc 03          	mov    %bl,0x3bc
   ede97:	a0 06 01             	mov    0x106,%al
   ede9a:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ede9c:	74 0f                	je     0xedead    ; driver var 00EDh: transfer progress counter A
   ede9e:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   edea3:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   edea8:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   edead:	a8 02                	test   $0x2,%al
   edeaf:	74 03                	je     0xedeb4    ; driver var 00EDh: transfer progress counter A
   edeb1:	e9 ed fc             	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A
   edeb4:	e9 e5 fc             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   edeb7:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   edebb:	b0 ae                	mov    $0xae,%al
   edebd:	9c                   	pushf
   edebe:	fa                   	cli
   edebf:	ee                   	out    %al,(%dx)    ; OUT command byte AEh via [0061] path: parameter/non-mcdx | Hardware/port write
   edec0:	a0 b5 03             	mov    0x3b5,%al
   edec3:	ee                   	out    %al,(%dx)    ; Hardware/port write
   edec4:	eb 00                	jmp    0xedec6    ; driver var 00EDh: transfer progress counter A
   edec6:	a0 b6 03             	mov    0x3b6,%al
   edec9:	ee                   	out    %al,(%dx)    ; Hardware/port write
   edeca:	eb 00                	jmp    0xedecc    ; driver var 00EDh: transfer progress counter A
   edecc:	a0 b7 03             	mov    0x3b7,%al
   edecf:	ee                   	out    %al,(%dx)    ; Hardware/port write
   eded0:	eb 00                	jmp    0xeded2    ; driver var 00EDh: transfer progress counter A
   eded2:	a0 b8 03             	mov    0x3b8,%al
   eded5:	ee                   	out    %al,(%dx)    ; Hardware/port write
   eded6:	9d                   	popf
   eded7:	e8 72 2a             	call   0xe094c
   ededa:	c3                   	ret
   ededb:	c6 06 c0 03 00       	movb   $0x0,0x3c0
   edee0:	33 c0                	xor    %ax,%ax
   edee2:	e8 f8 fb             	call   0xedadd    ; driver var 00EDh: transfer progress counter A
   edee5:	3c ff                	cmp    $0xff,%al
   edee7:	75 03                	jne    0xedeec    ; driver var 00EDh: transfer progress counter A
   edee9:	e9 31 02             	jmp    0xee11d
   edeec:	3c 04                	cmp    $0x4,%al
   edeee:	75 03                	jne    0xedef3    ; driver var 00EDh: transfer progress counter A
   edef0:	e9 da fb             	jmp    0xedacd    ; driver var 00EDh: transfer progress counter A
   edef3:	c6 06 c8 03 06       	movb   $0x6,0x3c8
   edef8:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   edefc:	b0 f8                	mov    $0xf8,%al    ; Mitsumi command F8h: close tray
   edefe:	ee                   	out    %al,(%dx)    ; OUT command byte F8h via [0061] path: close tray | Hardware/port write
   edeff:	eb 00                	jmp    0xedf01    ; driver var 00EDh: transfer progress counter A
   edf01:	e8 fd 16             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   edf04:	3c ff                	cmp    $0xff,%al
   edf06:	75 0c                	jne    0xedf14    ; driver var 00EDh: transfer progress counter A
   edf08:	fe 0e c8 03          	decb   0x3c8
   edf0c:	75 ea                	jne    0xedef8    ; driver var 00EDh: transfer progress counter A
   edf0e:	e8 d2 fd             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   edf11:	e9 09 02             	jmp    0xee11d
   edf14:	88 1e 06 01          	mov    %bl,0x106
   edf18:	f6 c3 01             	test   $0x1,%bl
   edf1b:	74 03                	je     0xedf20    ; driver var 00EDh: transfer progress counter A
   edf1d:	e9 ad fb             	jmp    0xedacd    ; driver var 00EDh: transfer progress counter A
   edf20:	f6 c3 20             	test   $0x20,%bl    ; Mitsumi command 20h: sub-Q candidate
   edf23:	74 0f                	je     0xedf34    ; driver var 00EDh: transfer progress counter A
   edf25:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   edf2a:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   edf2f:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   edf34:	f6 c3 02             	test   $0x2,%bl
   edf37:	74 03                	je     0xedf3c    ; driver var 00EDh: transfer progress counter A
   edf39:	e9 4e fb             	jmp    0xeda8a    ; driver var 00EDh: transfer progress counter A
   edf3c:	e9 4e fb             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   edf3f:	06                   	push   %es
   edf40:	57                   	push   %di
   edf41:	c4 1e 0e 05          	les    0x50e,%bx
   edf45:	8c c0                	mov    %es,%ax
   edf47:	0b d8                	or     %ax,%bx
   edf49:	75 16                	jne    0xedf61    ; driver var 00EDh: transfer progress counter A
   edf4b:	5f                   	pop    %di
   edf4c:	07                   	pop    %es
   edf4d:	06                   	push   %es
   edf4e:	57                   	push   %di
   edf4f:	26 c4 1d             	les    %es:(%di),%bx
   edf52:	b8 0e 05             	mov    $0x50e,%ax    ; Mitsumi command 50h: set drive mode
   edf55:	8b f8                	mov    %ax,%di
   edf57:	89 1d                	mov    %bx,(%di)
   edf59:	8c c0                	mov    %es,%ax
   edf5b:	89 45 02             	mov    %ax,0x2(%di)
   edf5e:	e8 07 00             	call   0xedf68    ; driver var 00EDh: transfer progress counter A
   edf61:	5f                   	pop    %di
   edf62:	07                   	pop    %es
   edf63:	33 c0                	xor    %ax,%ax
   edf65:	e9 25 fb             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A

; STRING @ 0xEDF68, length 6: SQRVWU
   edf68:	53                   	push   %bx
   edf69:	51                   	push   %cx
   edf6a:	52                   	push   %dx
   edf6b:	56                   	push   %si
   ...
   edf73:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   edf77:	b0 90                	mov    $0x90,%al    ; Mitsumi command 90h: configure
   edf79:	9c                   	pushf
   edf7a:	fa                   	cli
   edf7b:	ee                   	out    %al,(%dx)    ; OUT command byte 90h via [0061] path: configure | Hardware/port write
   edf7c:	b0 10                	mov    $0x10,%al    ; Mitsumi command 10h: TOC/disk info candidate
   edf7e:	ee                   	out    %al,(%dx)    ; Hardware/port write
   edf7f:	eb 00                	jmp    0xedf81    ; driver var 00EDh: transfer progress counter A
   edf81:	b0 0e                	mov    $0xe,%al
   edf83:	ee                   	out    %al,(%dx)    ; Hardware/port write
   edf84:	9d                   	popf
   edf85:	e8 c4 29             	call   0xe094c
   edf88:	07                   	pop    %es
   edf89:	1f                   	pop    %ds

; STRING @ 0xEDF8A, length 6: ]_^ZY[
   edf8a:	5d                   	pop    %bp
   edf8b:	5f                   	pop    %di
   edf8c:	5e                   	pop    %si
   edf8d:	5a                   	pop    %dx
   ...
   edfab:	72 02                	jb     0xedfaf    ; driver var 00EDh: transfer progress counter A
   edfad:	eb 03                	jmp    0xedfb2    ; driver var 00EDh: transfer progress counter A
   edfaf:	80 c6 10             	add    $0x10,%dh    ; Mitsumi command 10h: TOC/disk info candidate
   ...
   edfc1:	03 1e 03 01          	add    0x103,%bx    ; driver var 0103h: transfer-size limit
   edfc5:	72 02                	jb     0xedfc9    ; driver var 00EDh: transfer progress counter A
   edfc7:	eb 05                	jmp    0xedfce    ; driver var 00EDh: transfer progress counter A
   edfc9:	80 c6 10             	add    $0x10,%dh    ; Mitsumi command 10h: TOC/disk info candidate
   edfcc:	eb 04                	jmp    0xedfd2    ; driver var 00EDh: transfer progress counter A
   edfce:	8b 1e d7 00          	mov    0xd7,%bx
   edfd2:	81 3e 03 01 30 09    	cmpw   $0x930,0x103    ; driver var 0103h: transfer-size limit
   edfd8:	75 0c                	jne    0xedfe6    ; driver var 00EDh: transfer progress counter A
   edfda:	3e 89 9e 87 01       	mov    %bx,%ds:0x187(%bp)
   edfdf:	3e 89 96 c7 01       	mov    %dx,%ds:0x1c7(%bp)
   edfe4:	eb 0a                	jmp    0xedff0    ; driver var 00EDh: transfer progress counter A
   edfe6:	3e 89 9e 07 01       	mov    %bx,%ds:0x107(%bp)
   edfeb:	3e 89 96 47 01       	mov    %dx,%ds:0x147(%bp)
   edff0:	49                   	dec    %cx
   edff1:	03 1e 03 01          	add    0x103,%bx    ; driver var 0103h: transfer-size limit
   edff5:	8b c3                	mov    %bx,%ax
   edff7:	03 1e 03 01          	add    0x103,%bx    ; driver var 0103h: transfer-size limit
   edffb:	45                   	inc    %bp
   edffc:	45                   	inc    %bp
   edffd:	72 02                	jb     0xee001
   edfff:	eb 05                	jmp    0xee006
   ee001:	80 c6 10             	add    $0x10,%dh    ; Mitsumi command 10h: TOC/disk info candidate
   ee004:	eb 02                	jmp    0xee008
   ee006:	8b d8                	mov    %ax,%bx
   ee008:	81 3e 03 01 30 09    	cmpw   $0x930,0x103    ; driver var 0103h: transfer-size limit
   ...
   ee026:	e2 c9                	loop   0xedff1    ; driver var 00EDh: transfer progress counter A
   ee028:	c3                   	ret
   ee029:	e9 48 fb             	jmp    0xedb74    ; driver var 00EDh: transfer progress counter A

; ---------------------------------------------------------------------------
; media_check_handler @ 0xEE02C
; MEDIA CHECK handler.
; ---------------------------------------------------------------------------
   ee02c:	c6 06 01 05 00       	movb   $0x0,0x501    ; driver var 0501h: media/attention state
   ee031:	e9 40 fb             	jmp    0xedb74    ; driver var 00EDh: transfer progress counter A

; ---------------------------------------------------------------------------
; ioctl_input_handler @ 0xEE034
; IOCTL INPUT request handler and secondary dispatch entry.
; ---------------------------------------------------------------------------
   ...
   ee04c:	e9 3e fa             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ...
   ee061:	e8 2c 1e             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   ee064:	3c 01                	cmp    $0x1,%al
   ee066:	74 02                	je     0xee06a
   ee068:	eb 07                	jmp    0xee071
   ee06a:	e8 94 15             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   ee06d:	3c 01                	cmp    $0x1,%al
   ee06f:	74 03                	je     0xee074
   ee071:	e9 28 fb             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ee074:	e9 2a fb             	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A
   ee077:	e8 16 1e             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   ...
   ee08b:	e8 93 0f             	call   0xef021    ; driver var 00EFh: transfer progress counter B
   ...
   ee0a7:	e8 39 fc             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ...
   ee0bb:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   ...
   ee0f4:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ee0f6:	74 0f                	je     0xee107
   ee0f8:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   ee0fd:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ee102:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   ee107:	a8 02                	test   $0x2,%al
   ee109:	75 03                	jne    0xee10e
   ee10b:	e9 8e fa             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ee10e:	e9 90 fa             	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A
   ee111:	b8 0b 80             	mov    $0x800b,%ax
   ee114:	e9 76 f9             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ee117:	b8 03 80             	mov    $0x8003,%ax
   ee11a:	e9 70 f9             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ee11d:	b8 02 80             	mov    $0x8002,%ax
   ee120:	e9 6a f9             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ...
   ee15d:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ee15f:	74 0f                	je     0xee170
   ee161:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   ee166:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ee16b:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   ee170:	a8 02                	test   $0x2,%al
   ee172:	75 03                	jne    0xee177
   ee174:	e9 25 fa             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ee177:	e9 27 fa             	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A
   ...
   ee190:	e8 4a f9             	call   0xedadd    ; driver var 00EDh: transfer progress counter A
   ee193:	3c ff                	cmp    $0xff,%al
   ee195:	75 02                	jne    0xee199
   ee197:	eb 84                	jmp    0xee11d
   ee199:	3c 04                	cmp    $0x4,%al
   ee19b:	75 03                	jne    0xee1a0
   ee19d:	e9 2d f9             	jmp    0xedacd    ; driver var 00EDh: transfer progress counter A
   ee1a0:	e8 3a 27             	call   0xe08dd
   ee1a3:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ee1a8:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ee1ac:	b0 8e                	mov    $0x8e,%al
   ee1ae:	ee                   	out    %al,(%dx)    ; OUT command byte 8Eh via [0061] path: parameter/non-mcdx | Hardware/port write
   ...
   ee1be:	e8 22 fb             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ...
   ee1e2:	e8 fe fa             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ...
   ee203:	e8 dd fa             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ...
   ee226:	e8 ba fa             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ...
   ee24a:	e8 96 fa             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ...
   ee27d:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ee27f:	74 0f                	je     0xee290
   ee281:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   ee286:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ee28b:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   ee290:	a8 02                	test   $0x2,%al
   ee292:	74 03                	je     0xee297
   ee294:	e9 0a f9             	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A
   ee297:	e9 02 f9             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ee29a:	c6 06 c0 03 00       	movb   $0x0,0x3c0
   ee29f:	33 c0                	xor    %ax,%ax
   ee2a1:	26 88 05             	mov    %al,%es:(%di)
   ee2a4:	e9 ba fd             	jmp    0xee061
   ee2a7:	e8 e6 1b             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   ee2aa:	3c 02                	cmp    $0x2,%al
   ee2ac:	75 08                	jne    0xee2b6
   ee2ae:	b8 b7 1b             	mov    $0x1bb7,%ax
   ee2b1:	32 db                	xor    %bl,%bl
   ee2b3:	e9 a0 00             	jmp    0xee356
   ee2b6:	e8 48 13             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   ee2b9:	3c ff                	cmp    $0xff,%al
   ee2bb:	75 03                	jne    0xee2c0
   ee2bd:	e9 5d fe             	jmp    0xee11d
   ee2c0:	8a c3                	mov    %bl,%al
   ee2c2:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ee2c4:	74 0f                	je     0xee2d5
   ee2c6:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   ee2cb:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ee2d0:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   ee2d5:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   ee2d7:	75 05                	jne    0xee2de
   ee2d9:	b9 00 08             	mov    $0x800,%cx
   ee2dc:	eb 03                	jmp    0xee2e1
   ee2de:	b9 00 00             	mov    $0x0,%cx
   ee2e1:	51                   	push   %cx
   ee2e2:	e8 f8 f7             	call   0xedadd    ; driver var 00EDh: transfer progress counter A
   ee2e5:	59                   	pop    %cx
...
```
# 04 ee300 ee8ff midlevel helpers
...
```text
0xEE6E3  string[5]: GGGG&
0xEE8A9  string[5]: WVPSQ
```

## Annotated disassembly

```asm
   ee300:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ee304:	b0 fe                	mov    $0xfe,%al    ; Mitsumi command FEh: lock/unlock
   ee306:	9c                   	pushf
   ee307:	fa                   	cli
   ee308:	ee                   	out    %al,(%dx)    ; OUT command byte FEh via [0061] path: lock/unlock | Hardware/port write
   ee309:	b0 02                	mov    $0x2,%al
   ee30b:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ee30c:	9d                   	popf
   ...
   ee31a:	e8 c6 f9             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ...
   ee330:	e8 b0 f9             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ...
   ee36f:	e9 2f f8             	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A
   ee372:	e9 27 f8             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ...
   ee386:	e9 04 f7             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ...
   ee39a:	e8 f3 1a             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   ee39d:	3c 01                	cmp    $0x1,%al
   ee39f:	74 03                	je     0xee3a4
   ee3a1:	e9 4c 21             	jmp    0xe04f0
   ee3a4:	c6 06 f9 00 01       	movb   $0x1,0xf9
   ee3a9:	e8 55 12             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   ...
   ee3e4:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   ee3e6:	75 03                	jne    0xee3eb
   ee3e8:	e9 32 fd             	jmp    0xee11d
   ee3eb:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ee3ed:	74 0f                	je     0xee3fe
   ee3ef:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   ee3f4:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ee3f9:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   ee3fe:	80 3e 01 05 00       	cmpb   $0x0,0x501    ; driver var 0501h: media/attention state
   ee403:	74 12                	je     0xee417
   ee405:	e8 e6 00             	call   0xee4ee
   ee408:	e8 af 0c             	call   0xef0ba    ; driver var 00EFh: transfer progress counter B
   ee40b:	3c ff                	cmp    $0xff,%al
   ee40d:	74 05                	je     0xee414
   ee40f:	c6 06 01 05 00       	movb   $0x0,0x501    ; driver var 0501h: media/attention state
   ee414:	a0 06 01             	mov    0x106,%al
   ee417:	a8 02                	test   $0x2,%al
   ee419:	75 03                	jne    0xee41e
   ee41b:	e9 7e f7             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ee41e:	32 c0                	xor    %al,%al
   ee420:	e9 67 f6             	jmp    0xeda8a    ; driver var 00EDh: transfer progress counter A
   ee423:	e8 6a 1a             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   ...
   ee43f:	e8 bf 11             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   ee442:	8a c3                	mov    %bl,%al
   ee444:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   ...
   ee453:	a2 01 05             	mov    %al,0x501    ; driver var 0501h: media/attention state
   ee456:	a2 a8 03             	mov    %al,0x3a8
   ee459:	e9 40 f7             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ee45c:	80 3e a8 03 00       	cmpb   $0x0,0x3a8
   ee461:	74 09                	je     0xee46c
   ee463:	80 3e 01 05 00       	cmpb   $0x0,0x501    ; driver var 0501h: media/attention state
   ee468:	74 02                	je     0xee46c
   ee46a:	eb 2c                	jmp    0xee498
   ee46c:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ...
   ee4a6:	e8 11 0c             	call   0xef0ba    ; driver var 00EFh: transfer progress counter B
   ...
   ee4b5:	a2 01 05             	mov    %al,0x501    ; driver var 0501h: media/attention state
   ee4b8:	a2 a8 03             	mov    %al,0x3a8
   ee4bb:	e9 de f6             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ee4be:	b0 00                	mov    $0x0,%al
   ee4c0:	a2 a8 03             	mov    %al,0x3a8
   ee4c3:	a2 01 05             	mov    %al,0x501    ; driver var 0501h: media/attention state
   ee4c6:	e9 d3 f6             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ...
   ee4e5:	e9 b4 f6             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ee4e8:	b8 0c 80             	mov    $0x800c,%ax
   ee4eb:	e9 9f f5             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ee4ee:	06                   	push   %es
   ee4ef:	57                   	push   %di
   ...
   ee501:	07                   	pop    %es
   ee502:	c3                   	ret
   ee503:	e8 8a 19             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   ee506:	3c 01                	cmp    $0x1,%al
   ee508:	74 03                	je     0xee50d
   ee50a:	e9 e3 1f             	jmp    0xe04f0
   ee50d:	e8 11 0b             	call   0xef021    ; driver var 00EFh: transfer progress counter B
   ...
   ee55c:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   ee55e:	75 03                	jne    0xee563
   ee560:	e9 ba fb             	jmp    0xee11d
   ee563:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ee565:	74 0f                	je     0xee576
   ee567:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   ee56c:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ee571:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   ee576:	a8 02                	test   $0x2,%al
   ee578:	75 05                	jne    0xee57f
   ee57a:	32 c0                	xor    %al,%al
   ee57c:	e9 0e f5             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ee57f:	32 c0                	xor    %al,%al
   ee581:	e9 06 f5             	jmp    0xeda8a    ; driver var 00EDh: transfer progress counter A
   ee584:	b8 03 80             	mov    $0x8003,%ax
   ee587:	e9 03 f5             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ee58a:	e8 03 19             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   ...
   ee5aa:	e8 0d 0b             	call   0xef0ba    ; driver var 00EFh: transfer progress counter B
   ...
   ee61c:	5d                   	pop    %bp
   ee61d:	5e                   	pop    %si
   ee61e:	e8 e0 0f             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   ...
   ee630:	e9 69 f5             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ee633:	e9 6b f5             	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A
   ee636:	f8                   	clc
   ee637:	5d                   	pop    %bp
   ee638:	5e                   	pop    %si
   ee639:	b8 03 80             	mov    $0x8003,%ax
   ee63c:	e9 4e f4             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ee63f:	f8                   	clc
   ee640:	5d                   	pop    %bp
   ee641:	5e                   	pop    %si
   ee642:	b8 0b 80             	mov    $0x800b,%ax
   ee645:	e9 45 f4             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ee648:	e8 45 18             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   ...
   ee659:	e8 c5 09             	call   0xef021    ; driver var 00EFh: transfer progress counter B
   ...
   ee6b2:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   ee6b4:	75 03                	jne    0xee6b9
   ee6b6:	e9 64 fa             	jmp    0xee11d
   ee6b9:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ee6bb:	74 0f                	je     0xee6cc
   ee6bd:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   ee6c2:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ee6c7:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   ee6cc:	a8 02                	test   $0x2,%al
   ee6ce:	75 03                	jne    0xee6d3
   ee6d0:	e9 c9 f4             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ee6d3:	e9 cb f4             	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A
   ee6d6:	e9 38 fa             	jmp    0xee111
   ee6d9:	c6 06 26 04 00       	movb   $0x0,0x426
   ee6de:	c6 06 27 04 00       	movb   $0x0,0x427

; STRING @ 0xEE6E3, length 5: GGGG&
   ee6e3:	47                   	inc    %di
   ee6e4:	47                   	inc    %di
   ee6e5:	47                   	inc    %di
   ee6e6:	47                   	inc    %di
   ...
   ee80c:	e8 f2 0d             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   ...
   ee822:	e9 77 f3             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   ee825:	e9 79 f3             	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A
   ...
   ee839:	e9 51 f2             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ee83c:	e9 4b f2             	jmp    0xeda8a    ; driver var 00EDh: transfer progress counter A
   ee83f:	c6 06 26 04 00       	movb   $0x0,0x426
   ee844:	c6 06 27 04 00       	movb   $0x0,0x427
   ee849:	e8 91 20             	call   0xe08dd
   ee84c:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ee850:	b0 b0                	mov    $0xb0,%al
   ee852:	ee                   	out    %al,(%dx)    ; OUT command byte B0h via [0061] path: parameter/non-mcdx | Hardware/port write
   ee853:	a0 6f 00             	mov    0x6f,%al
   ee856:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ee857:	a0 70 00             	mov    0x70,%al
   ee85a:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ee85b:	a0 71 00             	mov    0x71,%al
   ee85e:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ee85f:	a0 72 00             	mov    0x72,%al
   ee862:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ee863:	a0 73 00             	mov    0x73,%al
   ee866:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ee867:	a0 74 00             	mov    0x74,%al
   ee86a:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ee86b:	c3                   	ret
...
; STRING @ 0xEE8A9, length 5: WVPSQ
   ...
   ee8d7:	47                   	inc    %di
   ee8d8:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
...
```
# 05 ee900 eefff transfer helpers
...
Transfer/status helper area.

## Local labels and strings

```text
0xEE96C  string[5]: Y[X^_
0xEE976  string[6]: WVPSQ3
0xEE9A0  string[5]: Y[X^_
0xEE9A8  string[5]: PSQRU
0xEE9D9  string[5]: ]ZY[X
0xEEA35  string[5]: WVPSQ
0xEEA90  string[5]: Y[X^_
0xEEC9D  string[4]: PSQR
0xEED16  string[4]: ZY[X
0xEEDB3  string[5]: PSUW3
0xEEE2C  string[4]: _][X
```
...
```asm
   ...
   ee947:	80 c4 10             	add    $0x10,%ah    ; Mitsumi command 10h: TOC/disk info candidate
...
; STRING @ 0xEE976, length 6: WVPSQ3
   ee976:	57                   	push   %di
   ee977:	56                   	push   %si
   ee978:	50                   	push   %ax
   ee979:	53                   	push   %bx
...
; STRING @ 0xEEDB3, length 5: PSUW3
   ...
   eee25:	24 c0                	and    $0xc0,%al    ; Mitsumi command C0h: read sector(s)
   eee27:	0a e0                	or     %al,%ah
   eee29:	88 66 00             	mov    %ah,0x0(%bp)

; STRING @ 0xEEE2C, length 4: _][X
   eee2c:	5f                   	pop    %di
   eee2d:	5d                   	pop    %bp
   eee2e:	5b                   	pop    %bx
   eee2f:	58                   	pop    %ax
   eee30:	90                   	nop
   eee31:	c3                   	ret
   eee32:	e8 5b 10             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   eee35:	3c 01                	cmp    $0x1,%al
   eee37:	74 03                	je     0xeee3c
   eee39:	e9 b4 16             	jmp    0xe04f0
   eee3c:	e8 e2 01             	call   0xef021    ; driver var 00EFh: transfer progress counter B
   ...
   eee4e:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   eee52:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   eee54:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
   eee55:	eb 00                	jmp    0xeee57
   eee57:	e8 f2 1a             	call   0xe094c
   eee5a:	3c ff                	cmp    $0xff,%al
   eee5c:	75 05                	jne    0xeee63
   eee5e:	e8 82 ee             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   eee61:	eb 4c                	jmp    0xeeeaf
   eee63:	8a c3                	mov    %bl,%al
   eee65:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   eee67:	75 03                	jne    0xeee6c
   eee69:	e9 b1 f2             	jmp    0xee11d
   eee6c:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   eee6e:	74 0f                	je     0xeee7f
   eee70:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   eee75:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   eee7a:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   eee7f:	e8 21 05             	call   0xef3a3    ; driver var 00EFh: transfer progress counter B
   ...
   eeea9:	e9 f5 ec             	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A
   eeeac:	e9 ed ec             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   eeeaf:	a0 00 01             	mov    0x100,%al
   eeeb2:	3c 00                	cmp    $0x0,%al
   eeeb4:	74 06                	je     0xeeebc
   eeeb6:	b8 08 80             	mov    $0x8008,%ax
   eeeb9:	e9 ce eb             	jmp    0xeda8a    ; driver var 00EDh: transfer progress counter A
   eeebc:	b8 08 80             	mov    $0x8008,%ax
   eeebf:	e9 cb eb             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   eeec2:	e8 cb 0f             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   eeec5:	3c 01                	cmp    $0x1,%al
   eeec7:	74 03                	je     0xeeecc
   eeec9:	e9 24 16             	jmp    0xe04f0
   eeecc:	e8 52 01             	call   0xef021    ; driver var 00EFh: transfer progress counter B
   ...
   eeede:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   eeee2:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   eeee4:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
   ...
   eeef4:	e8 ec ed             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ...
   eef15:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   eef17:	75 03                	jne    0xeef1c
   eef19:	e9 01 f2             	jmp    0xee11d
   eef1c:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   eef1e:	74 0f                	je     0xeef2f
   eef20:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   eef25:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ...
   eef71:	a0 6b 00             	mov    0x6b,%al    ; driver var 006Bh: MSF frame
   eef74:	e8 5c 1a             	call   0xe09d3
   eef77:	aa                   	stos   %al,%es:(%di)
   eef78:	a0 6a 00             	mov    0x6a,%al    ; driver var 006Ah: MSF second
   eef7b:	e8 55 1a             	call   0xe09d3
   eef7e:	aa                   	stos   %al,%es:(%di)
   eef7f:	a0 69 00             	mov    0x69,%al    ; driver var 0069h: MSF minute
   eef82:	e8 4e 1a             	call   0xe09d3
   eef85:	aa                   	stos   %al,%es:(%di)
   eef86:	32 c0                	xor    %al,%al
   eef88:	aa                   	stos   %al,%es:(%di)
   eef89:	a0 6e 00             	mov    0x6e,%al    ; driver var 006Eh: secondary MSF/count byte
   eef8c:	e8 44 1a             	call   0xe09d3
   eef8f:	aa                   	stos   %al,%es:(%di)
   eef90:	a0 6d 00             	mov    0x6d,%al    ; driver var 006Dh: secondary MSF/count byte
   eef93:	e8 3d 1a             	call   0xe09d3
   eef96:	aa                   	stos   %al,%es:(%di)
   eef97:	a0 6c 00             	mov    0x6c,%al    ; driver var 006Ch: secondary MSF/count byte
   eef9a:	e8 36 1a             	call   0xe09d3
   eef9d:	aa                   	stos   %al,%es:(%di)
   eef9e:	32 c0                	xor    %al,%al
   eefa0:	aa                   	stos   %al,%es:(%di)
   eefa1:	e9 fd eb             	jmp    0xedba1    ; driver var 00EDh: transfer progress counter A
   eefa4:	ab                   	stos   %ax,%es:(%di)
   eefa5:	32 c0                	xor    %al,%al
   eefa7:	b9 08 00             	mov    $0x8,%cx
   eefaa:	f3 aa                	rep stos %al,%es:(%di)
   eefac:	e9 ed eb             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   eefaf:	e9 c2 eb             	jmp    0xedb74    ; driver var 00EDh: transfer progress counter A
   ...
   eefc9:	e8 17 ed             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   eefcc:	c3                   	ret
   eefcd:	3c 01                	cmp    $0x1,%al
   eefcf:	75 02                	jne    0xeefd3
   eefd1:	eb 4b                	jmp    0xef01e    ; driver var 00EFh: transfer progress counter B
...
```
# 06 ef000 ef5ff mitsumi command helpers
...
Mitsumi command/status/mode/config helper cluster.

## Local labels and strings

```text
0xEF3A3  mitsumi_status_mode_config_cluster: Mitsumi command/status helper cluster. Sends commands such as 40h/50h/90h.
0xEF02C  string[4]: \r<\ru
0xEF04E  string[4]: \r<\rt
0xEF069  string[4]: \r<\ru
0xEF08B  string[4]: \r<\rt
0xEF0A6  string[4]: \r<\ru
```

## Annotated disassembly

```asm
   ef001:	75 18                	jne    0xef01b    ; driver var 00EFh: transfer progress counter B
   ef003:	83 3e 84 00 00       	cmpw   $0x0,0x84
   ef008:	75 11                	jne    0xef01b    ; driver var 00EFh: transfer progress counter B
   ef00a:	fe 0e c8 03          	decb   0x3c8
   ef00e:	75 03                	jne    0xef013    ; driver var 00EFh: transfer progress counter B
   ...
   ef024:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   ef028:	ec                   	in     (%dx),%al    ; Hardware/port read
   ef029:	24 0f                	and    $0xf,%al
   ef02b:	0c 0d                	or     $0xd,%al
   ef02d:	3c 0d                	cmp    $0xd,%al
   ef02f:	75 0b                	jne    0xef03c    ; driver var 00EFh: transfer progress counter B
   ef031:	b9 01 00             	mov    $0x1,%cx
   ef034:	e8 bf 19             	call   0xe09f6
   ef037:	4b                   	dec    %bx
   ef038:	75 ea                	jne    0xef024    ; driver var 00EFh: transfer progress counter B
   ef03a:	eb 22                	jmp    0xef05e    ; driver var 00EFh: transfer progress counter B
   ef03c:	bb 32 00             	mov    $0x32,%bx
   ef03f:	80 3e 08 05 01       	cmpb   $0x1,0x508
   ef044:	74 71                	je     0xef0b7    ; driver var 00EFh: transfer progress counter B
   ef046:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   ef04a:	ec                   	in     (%dx),%al    ; Hardware/port read
   ef04b:	24 0f                	and    $0xf,%al
   ef04d:	0c 0d                	or     $0xd,%al
   ef04f:	3c 0d                	cmp    $0xd,%al
   ef051:	74 0b                	je     0xef05e    ; driver var 00EFh: transfer progress counter B
   ef053:	b9 01 00             	mov    $0x1,%cx
   ef056:	e8 9d 19             	call   0xe09f6
   ef059:	4b                   	dec    %bx
   ef05a:	75 ee                	jne    0xef04a    ; driver var 00EFh: transfer progress counter B
   ef05c:	eb 59                	jmp    0xef0b7    ; driver var 00EFh: transfer progress counter B
   ef05e:	bb 3c 00             	mov    $0x3c,%bx
   ef061:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   ef065:	ec                   	in     (%dx),%al    ; Hardware/port read
   ef066:	24 0f                	and    $0xf,%al
   ef068:	0c 0d                	or     $0xd,%al
   ef06a:	3c 0d                	cmp    $0xd,%al
   ef06c:	75 0b                	jne    0xef079    ; driver var 00EFh: transfer progress counter B
   ef06e:	b9 01 00             	mov    $0x1,%cx
   ef071:	e8 82 19             	call   0xe09f6
   ef074:	4b                   	dec    %bx
   ef075:	75 ee                	jne    0xef065    ; driver var 00EFh: transfer progress counter B
   ef077:	eb 3b                	jmp    0xef0b4    ; driver var 00EFh: transfer progress counter B
   ef079:	bb 32 00             	mov    $0x32,%bx
   ef07c:	80 3e 08 05 01       	cmpb   $0x1,0x508
   ef081:	74 34                	je     0xef0b7    ; driver var 00EFh: transfer progress counter B
   ef083:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   ef087:	ec                   	in     (%dx),%al    ; Hardware/port read
   ef088:	24 0f                	and    $0xf,%al
   ef08a:	0c 0d                	or     $0xd,%al
   ef08c:	3c 0d                	cmp    $0xd,%al
   ef08e:	74 0b                	je     0xef09b    ; driver var 00EFh: transfer progress counter B
   ef090:	b9 01 00             	mov    $0x1,%cx
   ef093:	e8 60 19             	call   0xe09f6
   ef096:	4b                   	dec    %bx
   ef097:	75 ee                	jne    0xef087    ; driver var 00EFh: transfer progress counter B
   ef099:	eb 1c                	jmp    0xef0b7    ; driver var 00EFh: transfer progress counter B
   ef09b:	bb 3c 00             	mov    $0x3c,%bx
   ef09e:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   ef0a2:	ec                   	in     (%dx),%al    ; Hardware/port read
   ef0a3:	24 0f                	and    $0xf,%al
   ef0a5:	0c 0d                	or     $0xd,%al
   ef0a7:	3c 0d                	cmp    $0xd,%al
   ef0a9:	75 0c                	jne    0xef0b7    ; driver var 00EFh: transfer progress counter B
   ef0ab:	b9 01 00             	mov    $0x1,%cx
   ef0ae:	e8 45 19             	call   0xe09f6
   ef0b1:	4b                   	dec    %bx
   ef0b2:	75 ee                	jne    0xef0a2    ; driver var 00EFh: transfer progress counter B
   ef0b4:	b0 01                	mov    $0x1,%al
   ef0b6:	c3                   	ret
   ef0b7:	32 c0                	xor    %al,%al
   ef0b9:	c3                   	ret
   ef0ba:	e8 20 ea             	call   0xedadd    ; driver var 00EDh: transfer progress counter A
   ef0bd:	3c ff                	cmp    $0xff,%al
   ef0bf:	75 01                	jne    0xef0c2    ; driver var 00EFh: transfer progress counter B
   ef0c1:	c3                   	ret
   ef0c2:	3c 04                	cmp    $0x4,%al
   ef0c4:	75 11                	jne    0xef0d7    ; driver var 00EFh: transfer progress counter B
   ef0c6:	e8 38 05             	call   0xef601    ; driver var 00EFh: transfer progress counter B
   ef0c9:	3c ff                	cmp    $0xff,%al
   ef0cb:	75 01                	jne    0xef0ce    ; driver var 00EFh: transfer progress counter B
   ef0cd:	c3                   	ret
   ef0ce:	a0 06 01             	mov    0x106,%al
   ef0d1:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   ef0d3:	75 0c                	jne    0xef0e1    ; driver var 00EFh: transfer progress counter B
   ef0d5:	b0 ff                	mov    $0xff,%al
   ef0d7:	a0 06 01             	mov    0x106,%al
   ef0da:	a8 80                	test   $0x80,%al
   ef0dc:	74 03                	je     0xef0e1    ; driver var 00EFh: transfer progress counter B
   ef0de:	b0 ff                	mov    $0xff,%al
   ef0e0:	c3                   	ret
   ef0e1:	e8 f9 17             	call   0xe08dd
   ef0e4:	e8 cb fe             	call   0xeefb2
   ef0e7:	3c ff                	cmp    $0xff,%al
   ef0e9:	75 01                	jne    0xef0ec    ; driver var 00EFh: transfer progress counter B
   ef0eb:	c3                   	ret
   ef0ec:	3c 01                	cmp    $0x1,%al
   ef0ee:	75 01                	jne    0xef0f1    ; driver var 00EFh: transfer progress counter B
   ef0f0:	c3                   	ret
   ef0f1:	e8 cf 01             	call   0xef2c3    ; driver var 00EFh: transfer progress counter B
   ef0f4:	e8 e6 17             	call   0xe08dd
   ef0f7:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef0fc:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef100:	b0 70                	mov    $0x70,%al    ; Mitsumi command 70h: hold/pause
   ef102:	ee                   	out    %al,(%dx)    ; OUT command byte 70h via [0061] path: hold/pause | Hardware/port write
   ef103:	eb 00                	jmp    0xef105    ; driver var 00EFh: transfer progress counter B
   ef105:	e8 44 18             	call   0xe094c
   ef108:	3c ff                	cmp    $0xff,%al
   ef10a:	75 0f                	jne    0xef11b    ; driver var 00EFh: transfer progress counter B
   ef10c:	fe 0e c8 03          	decb   0x3c8
   ef110:	80 3e c8 03 01       	cmpb   $0x1,0x3c8
   ef115:	75 e5                	jne    0xef0fc    ; driver var 00EFh: transfer progress counter B
   ef117:	e8 c9 eb             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef11a:	c3                   	ret
   ef11b:	e8 bf 17             	call   0xe08dd
   ef11e:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef123:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef127:	b0 50                	mov    $0x50,%al    ; Mitsumi command 50h: set drive mode
   ef129:	9c                   	pushf
   ef12a:	fa                   	cli
   ef12b:	ee                   	out    %al,(%dx)    ; OUT command byte 50h via [0061] path: set drive mode | Hardware/port write
   ef12c:	b0 05                	mov    $0x5,%al
   ef12e:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef12f:	9d                   	popf
   ef130:	e8 19 18             	call   0xe094c
   ef133:	3c ff                	cmp    $0xff,%al
   ef135:	75 0a                	jne    0xef141    ; driver var 00EFh: transfer progress counter B
   ef137:	fe 0e c8 03          	decb   0x3c8
   ef13b:	75 e6                	jne    0xef123    ; driver var 00EFh: transfer progress counter B
   ef13d:	e8 a3 eb             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef140:	c3                   	ret
   ...
   ef156:	75 03                	jne    0xef15b    ; driver var 00EFh: transfer progress counter B
   ef158:	b0 ff                	mov    $0xff,%al
   ef15a:	c3                   	ret
   ef15b:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef160:	e8 09 16             	call   0xe076c
   ef163:	3c ff                	cmp    $0xff,%al
   ef165:	75 0a                	jne    0xef171    ; driver var 00EFh: transfer progress counter B
   ef167:	fe 0e c8 03          	decb   0x3c8
   ef16b:	75 f3                	jne    0xef160    ; driver var 00EFh: transfer progress counter B
   ef16d:	e8 73 eb             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef170:	c3                   	ret
   ef171:	3c 01                	cmp    $0x1,%al
   ef173:	75 02                	jne    0xef177    ; driver var 00EFh: transfer progress counter B
   ef175:	eb 3d                	jmp    0xef1b4    ; driver var 00EFh: transfer progress counter B
   ef177:	a0 98 00             	mov    0x98,%al
   ef17a:	3c 00                	cmp    $0x0,%al
   ef17c:	75 c9                	jne    0xef147    ; driver var 00EFh: transfer progress counter B
   ef17e:	a0 99 00             	mov    0x99,%al
   ef181:	3c a0                	cmp    $0xa0,%al
   ef183:	74 c2                	je     0xef147    ; driver var 00EFh: transfer progress counter B
   ef185:	3c a1                	cmp    $0xa1,%al
   ef187:	74 be                	je     0xef147    ; driver var 00EFh: transfer progress counter B
   ef189:	3c a2                	cmp    $0xa2,%al
   ef18b:	74 ba                	je     0xef147    ; driver var 00EFh: transfer progress counter B
   ef18d:	e8 d5 00             	call   0xef265    ; driver var 00EFh: transfer progress counter B
   ef190:	e8 5e 00             	call   0xef1f1    ; driver var 00EFh: transfer progress counter B
   ef193:	33 f6                	xor    %si,%si
   ef195:	8a 84 9a 03          	mov    0x39a(%si),%al
   ef199:	b9 0c 00             	mov    $0xc,%cx
   ef19c:	46                   	inc    %si
   ef19d:	22 84 9a 03          	and    0x39a(%si),%al
   ef1a1:	e2 f9                	loop   0xef19c    ; driver var 00EFh: transfer progress counter B
   ef1a3:	3c ff                	cmp    $0xff,%al
   ef1a5:	74 02                	je     0xef1a9    ; driver var 00EFh: transfer progress counter B
   ef1a7:	eb 9e                	jmp    0xef147    ; driver var 00EFh: transfer progress counter B
   ef1a9:	e8 1f 00             	call   0xef1cb    ; driver var 00EFh: transfer progress counter B
   ef1ac:	3c ff                	cmp    $0xff,%al
   ef1ae:	75 01                	jne    0xef1b1    ; driver var 00EFh: transfer progress counter B
   ef1b0:	c3                   	ret
   ...
   ef1be:	46                   	inc    %si
   ef1bf:	e2 f6                	loop   0xef1b7    ; driver var 00EFh: transfer progress counter B
   ef1c1:	e8 07 00             	call   0xef1cb    ; driver var 00EFh: transfer progress counter B
   ef1c4:	3c ff                	cmp    $0xff,%al
   ef1c6:	74 02                	je     0xef1ca    ; driver var 00EFh: transfer progress counter B
   ef1c8:	b0 01                	mov    $0x1,%al
   ef1ca:	c3                   	ret
   ef1cb:	e8 0f 17             	call   0xe08dd
   ef1ce:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef1d3:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef1d7:	b0 50                	mov    $0x50,%al    ; Mitsumi command 50h: set drive mode
   ef1d9:	9c                   	pushf
   ef1da:	fa                   	cli
   ef1db:	ee                   	out    %al,(%dx)    ; OUT command byte 50h via [0061] path: set drive mode | Hardware/port write
   ef1dc:	b0 01                	mov    $0x1,%al
   ef1de:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef1df:	9d                   	popf
   ef1e0:	e8 69 17             	call   0xe094c
   ef1e3:	3c ff                	cmp    $0xff,%al
   ef1e5:	75 09                	jne    0xef1f0    ; driver var 00EFh: transfer progress counter B
   ef1e7:	fe 0e c8 03          	decb   0x3c8
   ef1eb:	75 e6                	jne    0xef1d3    ; driver var 00EFh: transfer progress counter B
   ef1ed:	e8 f3 ea             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef1f0:	c3                   	ret
   ef1f1:	b8 07 02             	mov    $0x207,%ax    ; Mitsumi command 20h: sub-Q candidate
   ...
   ef20f:	74 0d                	je     0xef21e    ; driver var 00EFh: transfer progress counter B
   ef211:	a1 98 03             	mov    0x398,%ax
   ef214:	05 03 00             	add    $0x3,%ax
   ef217:	a3 98 03             	mov    %ax,0x398
   ef21a:	fe cb                	dec    %bl
   ef21c:	75 f6                	jne    0xef214    ; driver var 00EFh: transfer progress counter B
   ef21e:	a0 99 00             	mov    0x99,%al
   ef221:	24 f0                	and    $0xf0,%al
   ef223:	3c 00                	cmp    $0x0,%al
   ef225:	74 1f                	je     0xef246    ; driver var 00EFh: transfer progress counter B
   ...
   ef23e:	fe cb                	dec    %bl
   ef240:	75 f6                	jne    0xef238    ; driver var 00EFh: transfer progress counter B
   ef242:	fe c9                	dec    %cl
   ef244:	75 f0                	jne    0xef236    ; driver var 00EFh: transfer progress counter B
   ef246:	8b 1e 98 03          	mov    0x398,%bx
   ef24a:	b9 07 02             	mov    $0x207,%cx    ; Mitsumi command 20h: sub-Q candidate
   ...
   ef286:	74 21                	je     0xef2a9    ; driver var 00EFh: transfer progress counter B
   ef288:	b1 01                	mov    $0x1,%cl
   ef28a:	fe cb                	dec    %bl
   ef28c:	74 04                	je     0xef292    ; driver var 00EFh: transfer progress counter B
   ef28e:	d0 e1                	shl    $1,%cl
   ef290:	eb f8                	jmp    0xef28a    ; driver var 00EFh: transfer progress counter B
   ...
   ef2a7:	eb 19                	jmp    0xef2c2    ; driver var 00EFh: transfer progress counter B
   ...
   ef2cf:	e8 bc 00             	call   0xef38e    ; driver var 00EFh: transfer progress counter B
   ef2d2:	80 ff 00             	cmp    $0x0,%bh
   ef2d5:	74 3f                	je     0xef316    ; driver var 00EFh: transfer progress counter B
   ef2d7:	32 c9                	xor    %cl,%cl
   ef2d9:	fe cf                	dec    %bh
   ef2db:	74 07                	je     0xef2e4    ; driver var 00EFh: transfer progress counter B
   ef2dd:	d0 e1                	shl    $1,%cl
   ef2df:	80 c1 01             	add    $0x1,%cl
   ef2e2:	eb f5                	jmp    0xef2d9    ; driver var 00EFh: transfer progress counter B
   ...
   ef2fb:	74 30                	je     0xef32d    ; driver var 00EFh: transfer progress counter B
   ...
   ef310:	fe cb                	dec    %bl
   ef312:	75 e9                	jne    0xef2fd    ; driver var 00EFh: transfer progress counter B
   ef314:	eb 17                	jmp    0xef32d    ; driver var 00EFh: transfer progress counter B
   ...
   ef32b:	eb cb                	jmp    0xef2f8    ; driver var 00EFh: transfer progress counter B
   ef32d:	b8 9a 03             	mov    $0x39a,%ax
   ef330:	a3 98 03             	mov    %ax,0x398
   ef333:	a0 7d 00             	mov    0x7d,%al
   ef336:	e8 9a 16             	call   0xe09d3
   ef339:	e8 52 00             	call   0xef38e    ; driver var 00EFh: transfer progress counter B
   ef33c:	80 ff 00             	cmp    $0x0,%bh
   ef33f:	74 3b                	je     0xef37c    ; driver var 00EFh: transfer progress counter B
   ef341:	b1 ff                	mov    $0xff,%cl
   ef343:	d0 e1                	shl    $1,%cl
   ef345:	80 e1 fe             	and    $0xfe,%cl    ; Mitsumi command FEh: lock/unlock
   ef348:	fe cf                	dec    %bh
   ef34a:	75 f7                	jne    0xef343    ; driver var 00EFh: transfer progress counter B
   ...
   ef363:	74 28                	je     0xef38d    ; driver var 00EFh: transfer progress counter B
   ...
   ef378:	fe c3                	inc    %bl
   ef37a:	eb e4                	jmp    0xef360    ; driver var 00EFh: transfer progress counter B
   ...
   ef38b:	eb d3                	jmp    0xef360    ; driver var 00EFh: transfer progress counter B
   ef38d:	c3                   	ret
...
; ---------------------------------------------------------------------------
; mitsumi_status_mode_config_cluster @ 0xEF3A3
; Mitsumi command/status helper cluster. Sends commands such as 40h/50h/90h.
; ---------------------------------------------------------------------------
   ef3a3:	c6 06 00 01 00       	movb   $0x0,0x100
   ef3a8:	e8 32 15             	call   0xe08dd
   ef3ab:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef3b0:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef3b4:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   ef3b6:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
   ef3b7:	eb 00                	jmp    0xef3b9    ; driver var 00EFh: transfer progress counter B
   ef3b9:	e8 90 15             	call   0xe094c
   ef3bc:	3c ff                	cmp    $0xff,%al
   ef3be:	75 0a                	jne    0xef3ca    ; driver var 00EFh: transfer progress counter B
   ef3c0:	fe 0e c8 03          	decb   0x3c8
   ef3c4:	75 ea                	jne    0xef3b0    ; driver var 00EFh: transfer progress counter B
   ef3c6:	e8 1a e9             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef3c9:	c3                   	ret
   ef3ca:	f6 c3 02             	test   $0x2,%bl
   ef3cd:	74 08                	je     0xef3d7    ; driver var 00EFh: transfer progress counter B
   ef3cf:	c6 06 00 01 01       	movb   $0x1,0x100
   ef3d4:	eb 66                	jmp    0xef43c    ; driver var 00EFh: transfer progress counter B
   ef3d6:	90                   	nop
   ef3d7:	c6 06 00 01 00       	movb   $0x0,0x100
   ef3dc:	e8 fe 14             	call   0xe08dd
   ef3df:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef3e4:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef3e8:	b0 50                	mov    $0x50,%al    ; Mitsumi command 50h: set drive mode
   ef3ea:	9c                   	pushf
   ef3eb:	fa                   	cli
   ef3ec:	ee                   	out    %al,(%dx)    ; OUT command byte 50h via [0061] path: set drive mode | Hardware/port write
   ef3ed:	32 c0                	xor    %al,%al
   ef3ef:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef3f0:	9d                   	popf
   ef3f1:	e8 58 15             	call   0xe094c
   ef3f4:	3c ff                	cmp    $0xff,%al
   ef3f6:	75 0a                	jne    0xef402    ; driver var 00EFh: transfer progress counter B
   ef3f8:	fe 0e c8 03          	decb   0x3c8
   ef3fc:	75 e6                	jne    0xef3e4    ; driver var 00EFh: transfer progress counter B
   ef3fe:	e8 e2 e8             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef401:	c3                   	ret
   ef402:	c6 06 69 00 00       	movb   $0x0,0x69    ; driver var 0069h: MSF minute
   ef407:	c6 06 6a 00 01       	movb   $0x1,0x6a    ; driver var 006Ah: MSF second
   ef40c:	c6 06 6b 00 60       	movb   $0x60,0x6b    ; driver var 006Bh: MSF frame
   ef411:	c6 06 6c 00 00       	movb   $0x0,0x6c    ; driver var 006Ch: secondary MSF/count byte
   ef416:	c6 06 6d 00 06       	movb   $0x6,0x6d    ; driver var 006Dh: secondary MSF/count byte
   ef41b:	c6 06 6e 00 00       	movb   $0x0,0x6e    ; driver var 006Eh: secondary MSF/count byte
   ...
   ef430:	75 0a                	jne    0xef43c    ; driver var 00EFh: transfer progress counter B
   ef432:	fe 0e c8 03          	decb   0x3c8
   ef436:	75 f0                	jne    0xef428    ; driver var 00EFh: transfer progress counter B
   ef438:	e8 a8 e8             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef43b:	c3                   	ret
   ef43c:	e8 9e 14             	call   0xe08dd
   ef43f:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef444:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef448:	b0 90                	mov    $0x90,%al    ; Mitsumi command 90h: configure
   ef44a:	9c                   	pushf
   ef44b:	fa                   	cli
   ef44c:	ee                   	out    %al,(%dx)    ; OUT command byte 90h via [0061] path: configure | Hardware/port write
   ef44d:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef451:	b0 04                	mov    $0x4,%al
   ef453:	ee                   	out    %al,(%dx)    ; OUT command byte 04h via [0061] path: parameter/non-mcdx | Hardware/port write
   ef454:	eb 00                	jmp    0xef456    ; driver var 00EFh: transfer progress counter B
   ef456:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef45a:	b0 01                	mov    $0x1,%al
   ef45c:	ee                   	out    %al,(%dx)    ; OUT command byte 01h via [0061] path: parameter/non-mcdx | Hardware/port write
   ef45d:	9d                   	popf
   ef45e:	e8 eb 14             	call   0xe094c
   ef461:	3c ff                	cmp    $0xff,%al
   ef463:	75 0a                	jne    0xef46f    ; driver var 00EFh: transfer progress counter B
   ef465:	fe 0e c8 03          	decb   0x3c8
   ef469:	75 d9                	jne    0xef444    ; driver var 00EFh: transfer progress counter B
   ef46b:	e8 75 e8             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef46e:	c3                   	ret
   ...
   ef47f:	75 0c                	jne    0xef48d    ; driver var 00EFh: transfer progress counter B
   ef481:	fe 0e c8 03          	decb   0x3c8
   ef485:	75 f3                	jne    0xef47a    ; driver var 00EFh: transfer progress counter B
   ef487:	e8 59 e8             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef48a:	e9 cd 00             	jmp    0xef55a    ; driver var 00EFh: transfer progress counter B
   ef48d:	3c 01                	cmp    $0x1,%al
   ef48f:	75 03                	jne    0xef494    ; driver var 00EFh: transfer progress counter B
   ef491:	e9 c6 00             	jmp    0xef55a    ; driver var 00EFh: transfer progress counter B
   ef494:	a0 97 00             	mov    0x97,%al
   ef497:	a8 02                	test   $0x2,%al
   ef499:	75 14                	jne    0xef4af    ; driver var 00EFh: transfer progress counter B
   ef49b:	b9 01 00             	mov    $0x1,%cx
   ef49e:	e8 55 15             	call   0xe09f6
   ef4a1:	8b 0e fc 00          	mov    0xfc,%cx
   ef4a5:	49                   	dec    %cx
   ef4a6:	89 0e fc 00          	mov    %cx,0xfc
   ef4aa:	75 c9                	jne    0xef475    ; driver var 00EFh: transfer progress counter B
   ef4ac:	e9 ab 00             	jmp    0xef55a    ; driver var 00EFh: transfer progress counter B
   ef4af:	80 3e 00 01 00       	cmpb   $0x0,0x100
   ef4b4:	74 02                	je     0xef4b8    ; driver var 00EFh: transfer progress counter B
   ef4b6:	eb 48                	jmp    0xef500    ; driver var 00EFh: transfer progress counter B
   ef4b8:	e8 22 14             	call   0xe08dd
   ef4bb:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef4c0:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef4c4:	b0 70                	mov    $0x70,%al    ; Mitsumi command 70h: hold/pause
   ef4c6:	ee                   	out    %al,(%dx)    ; OUT command byte 70h via [0061] path: hold/pause | Hardware/port write
   ef4c7:	eb 00                	jmp    0xef4c9    ; driver var 00EFh: transfer progress counter B
   ef4c9:	e8 80 14             	call   0xe094c
   ef4cc:	3c ff                	cmp    $0xff,%al
   ef4ce:	75 0a                	jne    0xef4da    ; driver var 00EFh: transfer progress counter B
   ef4d0:	fe 0e c8 03          	decb   0x3c8
   ef4d4:	75 ea                	jne    0xef4c0    ; driver var 00EFh: transfer progress counter B
   ef4d6:	e8 0a e8             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef4d9:	c3                   	ret
   ef4da:	e8 00 14             	call   0xe08dd
   ef4dd:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef4e2:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef4e6:	b0 50                	mov    $0x50,%al    ; Mitsumi command 50h: set drive mode
   ef4e8:	9c                   	pushf
   ef4e9:	fa                   	cli
   ef4ea:	ee                   	out    %al,(%dx)    ; OUT command byte 50h via [0061] path: set drive mode | Hardware/port write
   ef4eb:	b0 01                	mov    $0x1,%al
   ef4ed:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef4ee:	9d                   	popf
   ef4ef:	e8 5a 14             	call   0xe094c
   ef4f2:	3c ff                	cmp    $0xff,%al
   ef4f4:	75 0a                	jne    0xef500    ; driver var 00EFh: transfer progress counter B
   ef4f6:	fe 0e c8 03          	decb   0x3c8
   ef4fa:	75 e6                	jne    0xef4e2    ; driver var 00EFh: transfer progress counter B
   ef4fc:	e8 e4 e7             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef4ff:	c3                   	ret
   ef500:	e8 da 13             	call   0xe08dd
   ef503:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef508:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef50c:	b0 90                	mov    $0x90,%al    ; Mitsumi command 90h: configure
   ef50e:	9c                   	pushf
   ef50f:	fa                   	cli
   ef510:	ee                   	out    %al,(%dx)    ; OUT command byte 90h via [0061] path: configure | Hardware/port write
   ef511:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef515:	b0 04                	mov    $0x4,%al
   ef517:	ee                   	out    %al,(%dx)    ; OUT command byte 04h via [0061] path: parameter/non-mcdx | Hardware/port write
   ef518:	eb 00                	jmp    0xef51a    ; driver var 00EFh: transfer progress counter B
   ef51a:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef51e:	32 c0                	xor    %al,%al
   ef520:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef521:	9d                   	popf
   ef522:	e8 27 14             	call   0xe094c
   ef525:	3c ff                	cmp    $0xff,%al
   ef527:	75 0a                	jne    0xef533    ; driver var 00EFh: transfer progress counter B
   ef529:	fe 0e c8 03          	decb   0x3c8
   ef52d:	75 d9                	jne    0xef508    ; driver var 00EFh: transfer progress counter B
   ef52f:	e8 b1 e7             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef532:	c3                   	ret
   ...
   ef552:	75 03                	jne    0xef557    ; driver var 00EFh: transfer progress counter B
   ef554:	e9 a7 00             	jmp    0xef5fe    ; driver var 00EFh: transfer progress counter B
   ef557:	32 c0                	xor    %al,%al
   ef559:	c3                   	ret
   ef55a:	80 3e 00 01 00       	cmpb   $0x0,0x100
   ef55f:	74 02                	je     0xef563    ; driver var 00EFh: transfer progress counter B
   ef561:	eb 48                	jmp    0xef5ab    ; driver var 00EFh: transfer progress counter B
   ef563:	e8 77 13             	call   0xe08dd
   ef566:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef56b:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef56f:	b0 70                	mov    $0x70,%al    ; Mitsumi command 70h: hold/pause
   ef571:	ee                   	out    %al,(%dx)    ; OUT command byte 70h via [0061] path: hold/pause | Hardware/port write
   ef572:	eb 00                	jmp    0xef574    ; driver var 00EFh: transfer progress counter B
   ef574:	e8 d5 13             	call   0xe094c
   ef577:	3c ff                	cmp    $0xff,%al
   ef579:	75 0a                	jne    0xef585    ; driver var 00EFh: transfer progress counter B
   ef57b:	fe 0e c8 03          	decb   0x3c8
   ef57f:	75 ea                	jne    0xef56b    ; driver var 00EFh: transfer progress counter B
   ef581:	e8 5f e7             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef584:	c3                   	ret
   ef585:	e8 55 13             	call   0xe08dd
   ef588:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef58d:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef591:	b0 50                	mov    $0x50,%al    ; Mitsumi command 50h: set drive mode
   ef593:	9c                   	pushf
   ef594:	fa                   	cli
   ef595:	ee                   	out    %al,(%dx)    ; OUT command byte 50h via [0061] path: set drive mode | Hardware/port write
   ef596:	b0 01                	mov    $0x1,%al
   ef598:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef599:	9d                   	popf
   ef59a:	e8 af 13             	call   0xe094c
   ef59d:	3c ff                	cmp    $0xff,%al
   ef59f:	75 0a                	jne    0xef5ab    ; driver var 00EFh: transfer progress counter B
   ef5a1:	fe 0e c8 03          	decb   0x3c8
   ef5a5:	75 e6                	jne    0xef58d    ; driver var 00EFh: transfer progress counter B
   ef5a7:	e8 39 e7             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef5aa:	c3                   	ret
   ef5ab:	e8 2f 13             	call   0xe08dd
   ef5ae:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef5b3:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef5b7:	b0 90                	mov    $0x90,%al    ; Mitsumi command 90h: configure
   ef5b9:	9c                   	pushf
   ef5ba:	fa                   	cli
   ef5bb:	ee                   	out    %al,(%dx)    ; OUT command byte 90h via [0061] path: configure | Hardware/port write
   ef5bc:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef5c0:	b0 04                	mov    $0x4,%al
   ef5c2:	ee                   	out    %al,(%dx)    ; OUT command byte 04h via [0061] path: parameter/non-mcdx | Hardware/port write
   ef5c3:	eb 00                	jmp    0xef5c5    ; driver var 00EFh: transfer progress counter B
   ef5c5:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef5c9:	32 c0                	xor    %al,%al
   ef5cb:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef5cc:	9d                   	popf
   ef5cd:	e8 7c 13             	call   0xe094c
   ef5d0:	3c ff                	cmp    $0xff,%al
   ef5d2:	75 0a                	jne    0xef5de    ; driver var 00EFh: transfer progress counter B
   ef5d4:	fe 0e c8 03          	decb   0x3c8
   ef5d8:	75 d9                	jne    0xef5b3    ; driver var 00EFh: transfer progress counter B
   ef5da:	e8 06 e7             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef5dd:	c3                   	ret
...
```
# 07 ef600 efbff request 80 read path
...
Request 80h primary read path and C0 packet.

## Local labels and strings

```text
0xEF656  request_80_read_transfer: Extended request 80h: primary read/transfer handler.
0xEF8C7  read80_c0_single_sector_packet: Sends C0 [0069] [006A] [006B] 00 00 01 read packet.
0xEF9C7  read80_call_general_c0_helper: Command 80h calls generalized C0 packet helper.
0xEF92C  string[4]: \r<\rt
0xEF95C  string[4]: \r<-t
0xEF967  string[4]: =0	u
```
...
```asm
   ...
   ef603:	e8 1b fa             	call   0xef021    ; driver var 00EFh: transfer progress counter B
   ef606:	3c 00                	cmp    $0x0,%al
   ef608:	75 21                	jne    0xef62b    ; driver var 00EFh: transfer progress counter B
   ef60a:	e8 d0 12             	call   0xe08dd
   ef60d:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef612:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef616:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   ef618:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
   ef619:	eb 00                	jmp    0xef61b    ; driver var 00EFh: transfer progress counter B
   ef61b:	e8 2e 13             	call   0xe094c
   ef61e:	3c ff                	cmp    $0xff,%al
   ef620:	75 0c                	jne    0xef62e    ; driver var 00EFh: transfer progress counter B
   ef622:	fe 0e c8 03          	decb   0x3c8
   ef626:	75 ea                	jne    0xef612    ; driver var 00EFh: transfer progress counter B
   ef628:	e8 b8 e6             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef62b:	b0 ff                	mov    $0xff,%al
   ef62d:	c3                   	ret
   ef62e:	8a c3                	mov    %bl,%al
   ef630:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   ef632:	75 04                	jne    0xef638    ; driver var 00EFh: transfer progress counter B
   ef634:	b8 02 00             	mov    $0x2,%ax
   ef637:	c3                   	ret
   ef638:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ef63a:	74 0f                	je     0xef64b    ; driver var 00EFh: transfer progress counter B
   ef63c:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   ef641:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ef646:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   ef64b:	a8 02                	test   $0x2,%al
   ef64d:	74 04                	je     0xef653    ; driver var 00EFh: transfer progress counter B
...
; ---------------------------------------------------------------------------
; request_80_read_transfer @ 0xEF656
; Extended request 80h: primary read/transfer handler.
; ---------------------------------------------------------------------------
   ef656:	c6 06 00 05 00       	movb   $0x0,0x500    ; driver var 0500h: transfer loop flag
   ef65b:	e8 32 08             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   ef65e:	3c 01                	cmp    $0x1,%al
   ef660:	74 03                	je     0xef665    ; driver var 00EFh: transfer progress counter B
   ef662:	e9 73 05             	jmp    0xefbd8    ; driver var 00EFh: transfer progress counter B
   ef665:	80 3e f4 04 00       	cmpb   $0x0,0x4f4
   ef66a:	74 18                	je     0xef684    ; driver var 00EFh: transfer progress counter B
   ef66c:	53                   	push   %bx
   ef66d:	06                   	push   %es
   ...
   ef678:	74 e8                	je     0xef662    ; driver var 00EFh: transfer progress counter B
   ef67a:	3c ff                	cmp    $0xff,%al
   ef67c:	74 e4                	je     0xef662    ; driver var 00EFh: transfer progress counter B
   ef67e:	e8 a9 06             	call   0xefd2a    ; driver var 00EFh: transfer progress counter B
   ef681:	e8 61 07             	call   0xefde5    ; driver var 00EFh: transfer progress counter B
   ...
   ef6b0:	74 15                	je     0xef6c7    ; driver var 00EFh: transfer progress counter B
   ef6b2:	80 3e f0 04 00       	cmpb   $0x0,0x4f0
   ef6b7:	74 0e                	je     0xef6c7    ; driver var 00EFh: transfer progress counter B
   ef6b9:	c6 06 f2 04 01       	movb   $0x1,0x4f2
   ef6be:	80 3e ff 04 01       	cmpb   $0x1,0x4ff
   ef6c3:	74 02                	je     0xef6c7    ; driver var 00EFh: transfer progress counter B
   ef6c5:	eb 05                	jmp    0xef6cc    ; driver var 00EFh: transfer progress counter B
   ef6c7:	c6 06 f2 04 00       	movb   $0x0,0x4f2
   ef6cc:	26 8b 4f 12          	mov    %es:0x12(%bx),%cx
   ef6d0:	83 f9 00             	cmp    $0x0,%cx
   ef6d3:	75 03                	jne    0xef6d8    ; driver var 00EFh: transfer progress counter B
   ef6d5:	e9 72 04             	jmp    0xefb4a    ; driver var 00EFh: transfer progress counter B
   ...
   ef6ee:	74 6b                	je     0xef75b    ; driver var 00EFh: transfer progress counter B
   ef6f0:	c6 06 f8 00 01       	movb   $0x1,0xf8
   ef6f5:	c7 06 e1 00 ff ff    	movw   $0xffff,0xe1
   ef6fb:	c7 06 e3 00 ff ff    	movw   $0xffff,0xe3
   ef701:	c7 06 ef 00 00 00    	movw   $0x0,0xef    ; driver var 00EFh: transfer progress counter B
   ef707:	c7 06 ed 00 00 00    	movw   $0x0,0xed    ; driver var 00EDh: transfer progress counter A
   ef70d:	3c 01                	cmp    $0x1,%al
   ef70f:	74 2b                	je     0xef73c    ; driver var 00EFh: transfer progress counter B
   ef711:	3c 00                	cmp    $0x0,%al
   ef713:	74 06                	je     0xef71b    ; driver var 00EFh: transfer progress counter B
   ef715:	b8 03 80             	mov    $0x8003,%ax
   ef718:	e9 72 e3             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ef71b:	c7 06 01 01 00 08    	movw   $0x800,0x101    ; driver var 0101h: transfer-size limit
   ef721:	c7 06 03 01 10 08    	movw   $0x810,0x103    ; driver var 0103h: transfer-size limit
   ef727:	80 3e bf 03 00       	cmpb   $0x0,0x3bf
   ef72c:	75 06                	jne    0xef734    ; driver var 00EFh: transfer progress counter B
   ef72e:	c7 06 03 01 00 08    	movw   $0x800,0x103    ; driver var 0103h: transfer-size limit
   ef734:	33 c9                	xor    %cx,%cx
   ef736:	8a 0e cc 00          	mov    0xcc,%cl
   ef73a:	eb 12                	jmp    0xef74e    ; driver var 00EFh: transfer progress counter B
   ef73c:	c7 06 01 01 30 09    	movw   $0x930,0x101    ; driver var 0101h: transfer-size limit
   ef742:	c7 06 03 01 30 09    	movw   $0x930,0x103    ; driver var 0103h: transfer-size limit
   ef748:	33 c9                	xor    %cx,%cx
   ef74a:	8a 0e cb 00          	mov    0xcb,%cl    ; driver var 00CBh: buffer count
   ef74e:	89 0e cd 00          	mov    %cx,0xcd    ; driver var 00CDh: transfer count base
   ef752:	49                   	dec    %cx
   ef753:	89 0e fa 00          	mov    %cx,0xfa    ; driver var 00FAh: sector/transfer count candidate
   ef757:	41                   	inc    %cx
   ...
   ef76f:	75 08                	jne    0xef779    ; driver var 00EFh: transfer progress counter B
   ef771:	05 96 00             	add    $0x96,%ax
   ef774:	83 d2 00             	adc    $0x0,%dx
   ef777:	eb 12                	jmp    0xef78b    ; driver var 00EFh: transfer progress counter B
   ef779:	26 80 7f 0d 01       	cmpb   $0x1,%es:0xd(%bx)
   ef77e:	74 08                	je     0xef788    ; driver var 00EFh: transfer progress counter B
   ef780:	5b                   	pop    %bx
   ef781:	07                   	pop    %es
   ef782:	b8 03 80             	mov    $0x8003,%ax
   ef785:	e9 05 e3             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ...
   ef7a8:	a2 69 00             	mov    %al,0x69    ; driver var 0069h: MSF minute
   ef7ab:	8a c5                	mov    %ch,%al
   ef7ad:	e8 6e 0f             	call   0xe071e
   ef7b0:	a2 6a 00             	mov    %al,0x6a    ; driver var 006Ah: MSF second
   ef7b3:	8a c1                	mov    %cl,%al
   ef7b5:	e8 66 0f             	call   0xe071e
   ef7b8:	a2 6b 00             	mov    %al,0x6b    ; driver var 006Bh: MSF frame
   ef7bb:	5b                   	pop    %bx
   ef7bc:	07                   	pop    %es
   ef7bd:	26 8b 47 12          	mov    %es:0x12(%bx),%ax
   ef7c1:	a3 79 00             	mov    %ax,0x79
   ef7c4:	c6 06 6c 00 f0       	movb   $0xf0,0x6c    ; driver var 006Ch: secondary MSF/count byte
   ef7c9:	c6 06 6d 00 00       	movb   $0x0,0x6d    ; driver var 006Dh: secondary MSF/count byte
   ef7ce:	c6 06 6e 00 00       	movb   $0x0,0x6e    ; driver var 006Eh: secondary MSF/count byte
   ef7d3:	a1 e7 00             	mov    0xe7,%ax
   ef7d6:	3b 06 e3 00          	cmp    0xe3,%ax
   ef7da:	75 0c                	jne    0xef7e8    ; driver var 00EFh: transfer progress counter B
   ef7dc:	a1 e5 00             	mov    0xe5,%ax
   ef7df:	3b 06 e1 00          	cmp    0xe1,%ax
   ef7e3:	75 03                	jne    0xef7e8    ; driver var 00EFh: transfer progress counter B
   ef7e5:	e9 42 02             	jmp    0xefa2a    ; driver var 00EFh: transfer progress counter B
   ...
   ef7f9:	80 3e 00 05 01       	cmpb   $0x1,0x500    ; driver var 0500h: transfer loop flag
   ef7fe:	74 0c                	je     0xef80c    ; driver var 00EFh: transfer progress counter B
   ef800:	c7 06 ed 00 00 00    	movw   $0x0,0xed    ; driver var 00EDh: transfer progress counter A
   ef806:	c7 06 ef 00 00 00    	movw   $0x0,0xef    ; driver var 00EFh: transfer progress counter B
   ef80c:	eb 14                	jmp    0xef822    ; driver var 00EFh: transfer progress counter B
   ef80e:	c6 06 f8 00 01       	movb   $0x1,0xf8
   ef813:	c7 06 e1 00 00 00    	movw   $0x0,0xe1
   ef819:	c7 06 e3 00 00 00    	movw   $0x0,0xe3
   ef81f:	e9 e0 03             	jmp    0xefc02    ; driver var 00EFh: transfer progress counter B
   ef822:	e8 b8 10             	call   0xe08dd
   ef825:	c6 06 c8 03 28       	movb   $0x28,0x3c8
   ef82a:	e8 f4 f7             	call   0xef021    ; driver var 00EFh: transfer progress counter B
   ef82d:	3c 01                	cmp    $0x1,%al
   ef82f:	75 02                	jne    0xef833    ; driver var 00EFh: transfer progress counter B
   ef831:	eb db                	jmp    0xef80e    ; driver var 00EFh: transfer progress counter B
   ef833:	b0 05                	mov    $0x5,%al
   ef835:	ba d4 00             	mov    $0xd4,%dx
   ef838:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef839:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef83d:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   ef83f:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
   ef840:	eb 00                	jmp    0xef842    ; driver var 00EFh: transfer progress counter B
   ef842:	e8 4b 11             	call   0xe0990
   ef845:	3c ff                	cmp    $0xff,%al
   ef847:	75 22                	jne    0xef86b    ; driver var 00EFh: transfer progress counter B
   ef849:	fe 0e c8 03          	decb   0x3c8
   ef84d:	75 db                	jne    0xef82a    ; driver var 00EFh: transfer progress counter B
   ef84f:	e8 91 e4             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ...
   ef868:	e9 84 03             	jmp    0xefbef    ; driver var 00EFh: transfer progress counter B
   ef86b:	8a c3                	mov    %bl,%al
   ef86d:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   ef86f:	75 03                	jne    0xef874    ; driver var 00EFh: transfer progress counter B
   ef871:	e9 64 03             	jmp    0xefbd8    ; driver var 00EFh: transfer progress counter B
   ef874:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ef876:	74 2c                	je     0xef8a4    ; driver var 00EFh: transfer progress counter B
   ef878:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   ef87d:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ef882:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   ef887:	e8 53 10             	call   0xe08dd
   ef88a:	e8 25 f7             	call   0xeefb2
   ef88d:	3c ff                	cmp    $0xff,%al
   ef88f:	75 03                	jne    0xef894    ; driver var 00EFh: transfer progress counter B
   ef891:	e9 44 03             	jmp    0xefbd8    ; driver var 00EFh: transfer progress counter B
   ef894:	3c 01                	cmp    $0x1,%al
   ef896:	75 03                	jne    0xef89b    ; driver var 00EFh: transfer progress counter B
   ef898:	e9 67 03             	jmp    0xefc02    ; driver var 00EFh: transfer progress counter B
   ef89b:	e8 8c 04             	call   0xefd2a    ; driver var 00EFh: transfer progress counter B
   ef89e:	e8 44 05             	call   0xefde5    ; driver var 00EFh: transfer progress counter B
   ef8a1:	a0 06 01             	mov    0x106,%al
   ef8a4:	a8 08                	test   $0x8,%al
   ef8a6:	75 03                	jne    0xef8ab    ; driver var 00EFh: transfer progress counter B
   ef8a8:	e9 af 00             	jmp    0xef95a    ; driver var 00EFh: transfer progress counter B
   ef8ab:	e8 83 0e             	call   0xe0731
   ef8ae:	3c 2d                	cmp    $0x2d,%al
   ef8b0:	74 03                	je     0xef8b5    ; driver var 00EFh: transfer progress counter B
   ef8b2:	e9 37 03             	jmp    0xefbec    ; driver var 00EFh: transfer progress counter B
...
; ---------------------------------------------------------------------------
; read80_c0_single_sector_packet @ 0xEF8C7
; Sends C0 [0069] [006A] [006B] 00 00 01 read packet.
; ---------------------------------------------------------------------------
   ef8c7:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef8cb:	b0 c0                	mov    $0xc0,%al    ; Mitsumi command C0h: read sector(s)
   ef8cd:	9c                   	pushf
   ef8ce:	fa                   	cli
   ef8cf:	ee                   	out    %al,(%dx)    ; OUT command byte C0h via [0061] path: read sectors | Hardware/port write
   ef8d0:	a0 69 00             	mov    0x69,%al    ; driver var 0069h: MSF minute
   ef8d3:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef8d4:	eb 00                	jmp    0xef8d6    ; driver var 00EFh: transfer progress counter B
   ef8d6:	a0 6a 00             	mov    0x6a,%al    ; driver var 006Ah: MSF second
   ef8d9:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef8da:	eb 00                	jmp    0xef8dc    ; driver var 00EFh: transfer progress counter B
   ef8dc:	a0 6b 00             	mov    0x6b,%al    ; driver var 006Bh: MSF frame
   ef8df:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef8e0:	eb 00                	jmp    0xef8e2    ; driver var 00EFh: transfer progress counter B
   ef8e2:	b0 00                	mov    $0x0,%al
   ef8e4:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef8e5:	eb 00                	jmp    0xef8e7    ; driver var 00EFh: transfer progress counter B
   ef8e7:	b0 00                	mov    $0x0,%al
   ef8e9:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef8ea:	eb 00                	jmp    0xef8ec    ; driver var 00EFh: transfer progress counter B
   ef8ec:	b0 01                	mov    $0x1,%al
   ef8ee:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef8ef:	9d                   	popf
   ef8f0:	b9 28 23             	mov    $0x2328,%cx
   ef8f3:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   ef8f7:	ec                   	in     (%dx),%al    ; Hardware/port read
   ef8f8:	24 0f                	and    $0xf,%al
   ef8fa:	8a d8                	mov    %al,%bl
   ef8fc:	0c 0b                	or     $0xb,%al
   ef8fe:	3c 0b                	cmp    $0xb,%al
   ef900:	74 2f                	je     0xef931    ; driver var 00EFh: transfer progress counter B
   ef902:	80 cb 0d             	or     $0xd,%bl
   ef905:	80 fb 0d             	cmp    $0xd,%bl
   ef908:	74 1e                	je     0xef928    ; driver var 00EFh: transfer progress counter B
   ef90a:	51                   	push   %cx
   ef90b:	b9 01 00             	mov    $0x1,%cx
   ef90e:	e8 e5 10             	call   0xe09f6
   ef911:	59                   	pop    %cx
   ef912:	49                   	dec    %cx
   ef913:	75 e2                	jne    0xef8f7    ; driver var 00EFh: transfer progress counter B
   ef915:	c6 06 b0 03 09       	movb   $0x9,0x3b0
   ef91a:	fe 0e c8 03          	decb   0x3c8
   ef91e:	74 02                	je     0xef922    ; driver var 00EFh: transfer progress counter B
   ef920:	eb a0                	jmp    0xef8c2    ; driver var 00EFh: transfer progress counter B
   ef922:	e8 be e3             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef925:	e9 c7 02             	jmp    0xefbef    ; driver var 00EFh: transfer progress counter B
   ef928:	ec                   	in     (%dx),%al    ; Hardware/port read
   ef929:	24 0f                	and    $0xf,%al
   ef92b:	0c 0d                	or     $0xd,%al
   ef92d:	3c 0d                	cmp    $0xd,%al
   ef92f:	74 f7                	je     0xef928    ; driver var 00EFh: transfer progress counter B
   ef931:	e8 18 10             	call   0xe094c
   ef934:	3c ff                	cmp    $0xff,%al
   ef936:	75 03                	jne    0xef93b    ; driver var 00EFh: transfer progress counter B
   ef938:	e9 b4 02             	jmp    0xefbef    ; driver var 00EFh: transfer progress counter B
   ef93b:	8a c3                	mov    %bl,%al
   ef93d:	a8 08                	test   $0x8,%al
   ef93f:	74 19                	je     0xef95a    ; driver var 00EFh: transfer progress counter B
   ...
   ef95f:	74 03                	je     0xef964    ; driver var 00EFh: transfer progress counter B
   ef961:	e9 88 02             	jmp    0xefbec    ; driver var 00EFh: transfer progress counter B
   ef964:	a1 01 01             	mov    0x101,%ax    ; driver var 0101h: transfer-size limit

; STRING @ 0xEF967, length 4: =0	u
   ef967:	3d 30 09             	cmp    $0x930,%ax
   ef96a:	75 07                	jne    0xef973    ; driver var 00EFh: transfer progress counter B
   ef96c:	c6 06 c5 00 61       	movb   $0x61,0xc5    ; driver var 0061h: command/data port candidate | driver var 00C5h: drive mode byte
   ef971:	eb 11                	jmp    0xef984    ; driver var 00EFh: transfer progress counter B
   ef973:	c6 06 c5 00 c1       	movb   $0xc1,0xc5    ; driver var 00C5h: drive mode byte
   ef978:	80 3e bf 03 00       	cmpb   $0x0,0x3bf
   ef97d:	75 05                	jne    0xef984    ; driver var 00EFh: transfer progress counter B
   ef97f:	c6 06 c5 00 01       	movb   $0x1,0xc5    ; driver var 00C5h: drive mode byte
   ef984:	e8 56 0f             	call   0xe08dd
   ef987:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   ef98c:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   ef990:	b0 50                	mov    $0x50,%al    ; Mitsumi command 50h: set drive mode
   ef992:	9c                   	pushf
   ef993:	fa                   	cli
   ef994:	ee                   	out    %al,(%dx)    ; OUT command byte 50h via [0061] path: set drive mode | Hardware/port write
   ef995:	a0 c5 00             	mov    0xc5,%al    ; driver var 00C5h: drive mode byte
   ef998:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ef999:	9d                   	popf
   ef99a:	e8 af 0f             	call   0xe094c
   ef99d:	3c ff                	cmp    $0xff,%al
   ef99f:	75 11                	jne    0xef9b2    ; driver var 00EFh: transfer progress counter B
   ef9a1:	fe 0e c8 03          	decb   0x3c8
   ef9a5:	75 e5                	jne    0xef98c    ; driver var 00EFh: transfer progress counter B
   ef9a7:	e8 39 e3             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef9aa:	c6 06 b0 03 0a       	movb   $0xa,0x3b0
   ef9af:	e9 3d 02             	jmp    0xefbef    ; driver var 00EFh: transfer progress counter B
...
; ---------------------------------------------------------------------------
; read80_call_general_c0_helper @ 0xEF9C7
; Command 80h calls generalized C0 packet helper.
; ---------------------------------------------------------------------------
   ef9c7:	e8 e1 0e             	call   0xe08ab
   ef9ca:	e8 7f 0f             	call   0xe094c
   ef9cd:	3c ff                	cmp    $0xff,%al
   ef9cf:	75 11                	jne    0xef9e2    ; driver var 00EFh: transfer progress counter B
   ef9d1:	fe 0e c8 03          	decb   0x3c8
   ef9d5:	75 e6                	jne    0xef9bd    ; driver var 00EFh: transfer progress counter B
   ef9d7:	e8 09 e3             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   ef9da:	c6 06 b0 03 02       	movb   $0x2,0x3b0
   ef9df:	e9 0d 02             	jmp    0xefbef    ; driver var 00EFh: transfer progress counter B
   ef9e2:	8a c3                	mov    %bl,%al
   ef9e4:	a8 01                	test   $0x1,%al
   ef9e6:	74 06                	je     0xef9ee    ; driver var 00EFh: transfer progress counter B
   ef9e8:	49                   	dec    %cx
   ef9e9:	75 ca                	jne    0xef9b5    ; driver var 00EFh: transfer progress counter B
   ef9eb:	e9 0b 02             	jmp    0xefbf9    ; driver var 00EFh: transfer progress counter B
   ...
   efa03:	2e a0 c6 00          	mov    %cs:0xc6,%al    ; driver var 00C6h: IRQ/vector selector
   efa07:	3c 0b                	cmp    $0xb,%al
   efa09:	75 05                	jne    0xefa10    ; driver var 00EFh: transfer progress counter B
   efa0b:	cd 73                	int    $0x73
   efa0d:	eb 1b                	jmp    0xefa2a    ; driver var 00EFh: transfer progress counter B
   efa0f:	90                   	nop
   efa10:	3c 05                	cmp    $0x5,%al
   efa12:	74 0c                	je     0xefa20    ; driver var 00EFh: transfer progress counter B
   efa14:	3c 04                	cmp    $0x4,%al
   efa16:	74 10                	je     0xefa28    ; driver var 00EFh: transfer progress counter B
   efa18:	3c 07                	cmp    $0x7,%al
   efa1a:	74 08                	je     0xefa24    ; driver var 00EFh: transfer progress counter B
   efa1c:	cd 0b                	int    $0xb
   efa1e:	eb 0a                	jmp    0xefa2a    ; driver var 00EFh: transfer progress counter B
   efa20:	cd 0d                	int    $0xd
   efa22:	eb 06                	jmp    0xefa2a    ; driver var 00EFh: transfer progress counter B
   efa24:	cd 0f                	int    $0xf
   efa26:	eb 02                	jmp    0xefa2a    ; driver var 00EFh: transfer progress counter B
   efa28:	cd 0c                	int    $0xc
   efa2a:	80 3e 00 05 01       	cmpb   $0x1,0x500    ; driver var 0500h: transfer loop flag
   efa2f:	75 03                	jne    0xefa34    ; driver var 00EFh: transfer progress counter B
   efa31:	e9 16 01             	jmp    0xefb4a    ; driver var 00EFh: transfer progress counter B
   efa34:	a1 79 00             	mov    0x79,%ax
   efa37:	3b 06 f5 00          	cmp    0xf5,%ax
   efa3b:	75 03                	jne    0xefa40    ; driver var 00EFh: transfer progress counter B
   efa3d:	e9 ba 00             	jmp    0xefafa    ; driver var 00EFh: transfer progress counter B
   efa40:	52                   	push   %dx
   efa41:	50                   	push   %ax
   ...
   efa4d:	fa                   	cli
   efa4e:	a1 ed 00             	mov    0xed,%ax    ; driver var 00EDh: transfer progress counter A
   efa51:	3b 06 ef 00          	cmp    0xef,%ax    ; driver var 00EFh: transfer progress counter B
   efa55:	77 09                	ja     0xefa60    ; driver var 00EFh: transfer progress counter B
   efa57:	a1 ef 00             	mov    0xef,%ax    ; driver var 00EFh: transfer progress counter B
   efa5a:	2b 06 ed 00          	sub    0xed,%ax    ; driver var 00EDh: transfer progress counter A
   efa5e:	eb 0b                	jmp    0xefa6b    ; driver var 00EFh: transfer progress counter B
   efa60:	a1 cd 00             	mov    0xcd,%ax    ; driver var 00CDh: transfer count base
   efa63:	2b 06 ed 00          	sub    0xed,%ax    ; driver var 00EDh: transfer progress counter A
   efa67:	03 06 ef 00          	add    0xef,%ax    ; driver var 00EFh: transfer progress counter B
   efa6b:	fb                   	sti
   efa6c:	3c 01                	cmp    $0x1,%al
   efa6e:	7d 76                	jge    0xefae6    ; driver var 00EFh: transfer progress counter B
   efa70:	80 3e f8 00 01       	cmpb   $0x1,0xf8
   efa75:	75 02                	jne    0xefa79    ; driver var 00EFh: transfer progress counter B
   efa77:	eb 40                	jmp    0xefab9    ; driver var 00EFh: transfer progress counter B
   efa79:	80 3e f9 00 01       	cmpb   $0x1,0xf9
   efa7e:	74 39                	je     0xefab9    ; driver var 00EFh: transfer progress counter B
   efa80:	b9 01 00             	mov    $0x1,%cx
   efa83:	e8 70 0f             	call   0xe09f6
   efa86:	4b                   	dec    %bx
   efa87:	75 14                	jne    0xefa9d    ; driver var 00EFh: transfer progress counter B
   efa89:	c6 06 f8 00 01       	movb   $0x1,0xf8
   efa8e:	c7 06 e1 00 ff ff    	movw   $0xffff,0xe1
   efa94:	c7 06 e3 00 ff ff    	movw   $0xffff,0xe3
   efa9a:	e9 c5 00             	jmp    0xefb62    ; driver var 00EFh: transfer progress counter B
   efa9d:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   efaa1:	c6 06 03 05 01       	movb   $0x1,0x503
   efaa6:	ec                   	in     (%dx),%al    ; Hardware/port read
   efaa7:	24 0f                	and    $0xf,%al
   efaa9:	0c 0b                	or     $0xb,%al
   efaab:	3c 0b                	cmp    $0xb,%al
   efaad:	75 03                	jne    0xefab2    ; driver var 00EFh: transfer progress counter B
   efaaf:	e9 9b 00             	jmp    0xefb4d    ; driver var 00EFh: transfer progress counter B
   efab2:	c6 06 03 05 00       	movb   $0x0,0x503
   efab7:	eb 94                	jmp    0xefa4d    ; driver var 00EFh: transfer progress counter B
   ...
   efae3:	e9 ba fc             	jmp    0xef7a0    ; driver var 00EFh: transfer progress counter B
   efae6:	e8 2d 01             	call   0xefc16    ; driver var 00EFh: transfer progress counter B
   efae9:	c6 06 b2 03 00       	movb   $0x0,0x3b2
   efaee:	a1 f5 00             	mov    0xf5,%ax
   efaf1:	3b 06 79 00          	cmp    0x79,%ax
   efaf5:	74 03                	je     0xefafa    ; driver var 00EFh: transfer progress counter B
   efaf7:	e9 46 ff             	jmp    0xefa40    ; driver var 00EFh: transfer progress counter B
   efafa:	a1 79 00             	mov    0x79,%ax
   efafd:	83 f2 00             	xor    $0x0,%dx
   efb00:	80 3e f2 04 00       	cmpb   $0x0,0x4f2
   efb05:	74 0b                	je     0xefb12    ; driver var 00EFh: transfer progress counter B
   efb07:	33 c0                	xor    %ax,%ax
   efb09:	33 d2                	xor    %dx,%dx
   efb0b:	8b 0e 79 00          	mov    0x79,%cx
   efb0f:	e8 4c 03             	call   0xefe5e    ; driver var 00EFh: transfer progress counter B
   ...
   efb26:	75 22                	jne    0xefb4a    ; driver var 00EFh: transfer progress counter B
   efb28:	e8 e1 01             	call   0xefd0c    ; driver var 00EFh: transfer progress counter B
   ...
   efb3e:	06                   	push   %es
   efb3f:	53                   	push   %bx
   efb40:	c6 06 00 05 01       	movb   $0x1,0x500    ; driver var 0500h: transfer loop flag
   efb45:	e9 58 fc             	jmp    0xef7a0    ; driver var 00EFh: transfer progress counter B
   efb48:	eb 00                	jmp    0xefb4a    ; driver var 00EFh: transfer progress counter B
   efb4a:	e9 4f e0             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   efb4d:	e8 fc 0d             	call   0xe094c
   efb50:	3c ff                	cmp    $0xff,%al
   efb52:	75 03                	jne    0xefb57    ; driver var 00EFh: transfer progress counter B
   efb54:	e9 81 00             	jmp    0xefbd8    ; driver var 00EFh: transfer progress counter B
   efb57:	80 e3 04             	and    $0x4,%bl
   efb5a:	80 fb 04             	cmp    $0x4,%bl
   efb5d:	75 03                	jne    0xefb62    ; driver var 00EFh: transfer progress counter B
   efb5f:	e9 97 00             	jmp    0xefbf9    ; driver var 00EFh: transfer progress counter B
   efb62:	a1 79 00             	mov    0x79,%ax
   efb65:	8b 16 f5 00          	mov    0xf5,%dx
   efb69:	2b c2                	sub    %dx,%ax
   efb6b:	75 03                	jne    0xefb70    ; driver var 00EFh: transfer progress counter B
   efb6d:	e9 2c e0             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   efb70:	fe 06 b2 03          	incb   0x3b2
   efb74:	80 3e b2 03 07       	cmpb   $0x7,0x3b2
   efb79:	72 03                	jb     0xefb7e    ; driver var 00EFh: transfer progress counter B
   efb7b:	e9 84 00             	jmp    0xefc02    ; driver var 00EFh: transfer progress counter B
   efb7e:	c6 06 f8 00 01       	movb   $0x1,0xf8
   efb83:	ba d4 00             	mov    $0xd4,%dx
   efb86:	b0 05                	mov    $0x5,%al
   efb88:	ee                   	out    %al,(%dx)    ; Hardware/port write
   efb89:	eb 00                	jmp    0xefb8b    ; driver var 00EFh: transfer progress counter B
   efb8b:	e8 93 f4             	call   0xef021    ; driver var 00EFh: transfer progress counter B
   efb8e:	3c 01                	cmp    $0x1,%al
   efb90:	74 1b                	je     0xefbad    ; driver var 00EFh: transfer progress counter B
   efb92:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   efb97:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   efb9b:	b0 70                	mov    $0x70,%al    ; Mitsumi command 70h: hold/pause
   efb9d:	ee                   	out    %al,(%dx)    ; OUT command byte 70h via [0061] path: hold/pause | Hardware/port write
   efb9e:	eb 00                	jmp    0xefba0    ; driver var 00EFh: transfer progress counter B
   efba0:	e8 a9 0d             	call   0xe094c
   efba3:	3c ff                	cmp    $0xff,%al
   efba5:	75 06                	jne    0xefbad    ; driver var 00EFh: transfer progress counter B
   efba7:	fe 0e c8 03          	decb   0x3c8
   efbab:	75 ea                	jne    0xefb97    ; driver var 00EFh: transfer progress counter B
   ...
   efbd3:	06                   	push   %es
   efbd4:	53                   	push   %bx
   efbd5:	e9 c8 fb             	jmp    0xef7a0    ; driver var 00EFh: transfer progress counter B
   ...
   efbf4:	74 e2                	je     0xefbd8    ; driver var 00EFh: transfer progress counter B
   efbf6:	e9 72 fc             	jmp    0xef86b    ; driver var 00EFh: transfer progress counter B
   efbf9:	e9 ec e8             	jmp    0xee4e8
   efbfc:	b8 00 01             	mov    $0x100,%ax    ; Mitsumi command 10h: TOC/disk info candidate
   efbff:	e9 8b de             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
```
# 08 efc00 f01ff handlers 82 83 84 start
...
Handlers 82h/83h and start of 84h.

## Local labels and strings

```text
0xEFE93  request_82_position_status_msf: Extended request 82h: position/status with MSF fields.
0xF000E  request_83_compact_position_status: Extended request 83h: compact position/status request.
0xF01A0  request_84_range_command: Extended request 84h: range command / range-transfer candidate.
0xEFC18  string[5]: WVPSQ
0xEFCBD  string[5]: fWfVf
0xEFCCC  string[4]: f^f_
0xEFD04  string[5]: Y[X^_
0xEFD2A  string[6]: SQRVWU
0xEFDDE  string[6]: ]_^ZY[
0xEFDED  string[6]: SQRVWU
0xEFE57  string[6]: ]_^ZY[
0xEFFF0  string[5]: $@<@u
0xF00F5  string[5]: $@<@t
0xF00FF  string[6]: $ < u)
0xF015B  string[5]: $@<@u
...
; STRING @ 0xEFC18, length 5: WVPSQ
   ...
   efc22:	74 25                	je     0xefc49    ; driver var 00EFh: transfer progress counter B
   efc24:	80 3e ef 04 00       	cmpb   $0x0,0x4ef
   efc29:	74 02                	je     0xefc2d    ; driver var 00EFh: transfer progress counter B
   efc2b:	eb 1c                	jmp    0xefc49    ; driver var 00EFh: transfer progress counter B
   efc2d:	80 3e f1 04 00       	cmpb   $0x0,0x4f1
   efc32:	75 0e                	jne    0xefc42    ; driver var 00EFh: transfer progress counter B
   efc34:	a0 ee 04             	mov    0x4ee,%al
   efc37:	a2 ef 04             	mov    %al,0x4ef
   efc3a:	a0 f0 04             	mov    0x4f0,%al
   efc3d:	a2 f1 04             	mov    %al,0x4f1
   efc40:	eb 07                	jmp    0xefc49    ; driver var 00EFh: transfer progress counter B
   efc42:	fe 0e f1 04          	decb   0x4f1
   efc46:	e9 aa 00             	jmp    0xefcf3    ; driver var 00EFh: transfer progress counter B
   ...
   efc59:	8b 0e 01 01          	mov    0x101,%cx    ; driver var 0101h: transfer-size limit
   efc5d:	06                   	push   %es
   efc5e:	57                   	push   %di
   efc5f:	51                   	push   %cx
   efc60:	8b df                	mov    %di,%bx
   efc62:	80 fc f0             	cmp    $0xf0,%ah
   efc65:	72 07                	jb     0xefc6e    ; driver var 00EFh: transfer progress counter B
   efc67:	8b fb                	mov    %bx,%di
   efc69:	8b d8                	mov    %ax,%bx
   efc6b:	eb 10                	jmp    0xefc7d    ; driver var 00EFh: transfer progress counter B
   efc6d:	90                   	nop
   efc6e:	53                   	push   %bx
   ...
   efc82:	8b 1e ed 00          	mov    0xed,%bx    ; driver var 00EDh: transfer progress counter A
   efc86:	d0 e3                	shl    $1,%bl
   efc88:	8b b7 87 01          	mov    0x187(%bx),%si
   efc8c:	b8 ff ff             	mov    $0xffff,%ax
   efc8f:	83 c6 10             	add    $0x10,%si    ; Mitsumi command 10h: TOC/disk info candidate
   efc92:	81 3e 01 01 30 09    	cmpw   $0x930,0x101    ; driver var 0101h: transfer-size limit
   efc98:	74 14                	je     0xefcae    ; driver var 00EFh: transfer progress counter B
   efc9a:	8b b7 07 01          	mov    0x107(%bx),%si
   efc9e:	b8 ff ff             	mov    $0xffff,%ax
   efca1:	83 c6 10             	add    $0x10,%si    ; Mitsumi command 10h: TOC/disk info candidate
   efca4:	80 3e bf 03 00       	cmpb   $0x0,0x3bf
   efca9:	74 03                	je     0xefcae    ; driver var 00EFh: transfer progress counter B
   efcab:	83 c6 10             	add    $0x10,%si    ; Mitsumi command 10h: TOC/disk info candidate
   efcae:	8e d8                	mov    %ax,%ds
   efcb0:	fc                   	cld
   efcb1:	d1 e9                	shr    $1,%cx
   efcb3:	2e 80 3e f5 04 03    	cmpb   $0x3,%cs:0x4f5
   efcb9:	72 17                	jb     0xefcd2    ; driver var 00EFh: transfer progress counter B
   efcbb:	d1 e9                	shr    $1,%cx

; STRING @ 0xEFCBD, length 5: fWfVf
...
; STRING @ 0xEFCCC, length 4: f^f_
   efccc:	66 5e                	pop    %esi
   efcce:	66 5f                	pop    %edi
   efcd0:	eb 02                	jmp    0xefcd4    ; driver var 00EFh: transfer progress counter B
   ...
   efcdb:	73 03                	jae    0xefce0    ; driver var 00EFh: transfer progress counter B
   efcdd:	80 c4 10             	add    $0x10,%ah    ; Mitsumi command 10h: TOC/disk info candidate
   ...
   efcf5:	a1 ed 00             	mov    0xed,%ax    ; driver var 00EDh: transfer progress counter A
   efcf8:	40                   	inc    %ax
   efcf9:	3b 06 fa 00          	cmp    0xfa,%ax    ; driver var 00FAh: sector/transfer count candidate
   efcfd:	76 02                	jbe    0xefd01    ; driver var 00EFh: transfer progress counter B
   efcff:	33 c0                	xor    %ax,%ax
   efd01:	a3 ed 00             	mov    %ax,0xed    ; driver var 00EDh: transfer progress counter A

; STRING @ 0xEFD04, length 5: Y[X^_
   efd04:	59                   	pop    %cx
   efd05:	5b                   	pop    %bx
   efd06:	58                   	pop    %ax
   efd07:	5e                   	pop    %si
   ...
   efd0a:	07                   	pop    %es
   efd0b:	c3                   	ret
   efd0c:	a1 ed 00             	mov    0xed,%ax    ; driver var 00EDh: transfer progress counter A
   efd0f:	3b 06 ef 00          	cmp    0xef,%ax    ; driver var 00EFh: transfer progress counter B
   efd13:	77 09                	ja     0xefd1e    ; driver var 00EFh: transfer progress counter B
   efd15:	a1 ef 00             	mov    0xef,%ax    ; driver var 00EFh: transfer progress counter B
   efd18:	2b 06 ed 00          	sub    0xed,%ax    ; driver var 00EDh: transfer progress counter A
   efd1c:	eb 0b                	jmp    0xefd29    ; driver var 00EFh: transfer progress counter B
   efd1e:	a1 cd 00             	mov    0xcd,%ax    ; driver var 00CDh: transfer count base
   efd21:	2b 06 ed 00          	sub    0xed,%ax    ; driver var 00EDh: transfer progress counter A
   efd25:	03 06 ef 00          	add    0xef,%ax    ; driver var 00EFh: transfer progress counter B
   efd29:	c3                   	ret

; STRING @ 0xEFD2A, length 6: SQRVWU
   efd2a:	53                   	push   %bx
   efd2b:	51                   	push   %cx
   efd2c:	52                   	push   %dx
   efd2d:	56                   	push   %si
   ...
   efd3c:	7f 15                	jg     0xefd53    ; driver var 00EFh: transfer progress counter B
   efd3e:	81 3e a3 00 66 21    	cmpw   $0x2166,0xa3
   efd44:	7f 0d                	jg     0xefd53    ; driver var 00EFh: transfer progress counter B
   efd46:	f7 06 a3 00 00 80    	testw  $0x8000,0xa3
   efd4c:	75 05                	jne    0xefd53    ; driver var 00EFh: transfer progress counter B
   efd4e:	32 c0                	xor    %al,%al
   efd50:	e9 89 00             	jmp    0xefddc    ; driver var 00EFh: transfer progress counter B
   efd53:	c6 06 69 00 00       	movb   $0x0,0x69    ; driver var 0069h: MSF minute
   efd58:	c6 06 6a 00 02       	movb   $0x2,0x6a    ; driver var 006Ah: MSF second
   efd5d:	c6 06 6b 00 00       	movb   $0x0,0x6b    ; driver var 006Bh: MSF frame
   efd62:	c6 06 6c 00 00       	movb   $0x0,0x6c    ; driver var 006Ch: secondary MSF/count byte
   efd67:	c6 06 6d 00 00       	movb   $0x0,0x6d    ; driver var 006Dh: secondary MSF/count byte
   efd6c:	c6 06 6e 00 00       	movb   $0x0,0x6e    ; driver var 006Eh: secondary MSF/count byte
   efd71:	e8 69 0b             	call   0xe08dd
   efd74:	e8 34 0b             	call   0xe08ab
   efd77:	e8 d2 0b             	call   0xe094c
   efd7a:	3c ff                	cmp    $0xff,%al
   efd7c:	75 02                	jne    0xefd80    ; driver var 00EFh: transfer progress counter B
   efd7e:	eb 5c                	jmp    0xefddc    ; driver var 00EFh: transfer progress counter B
   efd80:	c6 06 69 00 01       	movb   $0x1,0x69    ; driver var 0069h: MSF minute
   efd85:	c6 06 6a 00 50       	movb   $0x50,0x6a    ; Mitsumi command 50h: set drive mode | driver var 006Ah: MSF second
   efd8a:	c6 06 6b 00 00       	movb   $0x0,0x6b    ; driver var 006Bh: MSF frame
   efd8f:	c6 06 6c 00 00       	movb   $0x0,0x6c    ; driver var 006Ch: secondary MSF/count byte
   efd94:	c6 06 6d 00 00       	movb   $0x0,0x6d    ; driver var 006Dh: secondary MSF/count byte
   efd99:	c6 06 6e 00 00       	movb   $0x0,0x6e    ; driver var 006Eh: secondary MSF/count byte
   efd9e:	e8 3c 0b             	call   0xe08dd
   efda1:	e8 07 0b             	call   0xe08ab
   efda4:	e8 a5 0b             	call   0xe094c
   efda7:	3c ff                	cmp    $0xff,%al
   efda9:	75 02                	jne    0xefdad    ; driver var 00EFh: transfer progress counter B
   efdab:	eb 2f                	jmp    0xefddc    ; driver var 00EFh: transfer progress counter B
   efdad:	c6 06 69 00 00       	movb   $0x0,0x69    ; driver var 0069h: MSF minute
   efdb2:	c6 06 6a 00 02       	movb   $0x2,0x6a    ; driver var 006Ah: MSF second
   efdb7:	c6 06 6b 00 00       	movb   $0x0,0x6b    ; driver var 006Bh: MSF frame
   efdbc:	c6 06 6c 00 00       	movb   $0x0,0x6c    ; driver var 006Ch: secondary MSF/count byte
   efdc1:	c6 06 6d 00 00       	movb   $0x0,0x6d    ; driver var 006Dh: secondary MSF/count byte
   efdc6:	c6 06 6e 00 00       	movb   $0x0,0x6e    ; driver var 006Eh: secondary MSF/count byte
   efdcb:	e8 0f 0b             	call   0xe08dd
   efdce:	e8 da 0a             	call   0xe08ab
   efdd1:	e8 78 0b             	call   0xe094c
   efdd4:	3c ff                	cmp    $0xff,%al
   efdd6:	75 02                	jne    0xefdda    ; driver var 00EFh: transfer progress counter B
   efdd8:	eb 02                	jmp    0xefddc    ; driver var 00EFh: transfer progress counter B
   efdda:	32 c0                	xor    %al,%al
   efddc:	07                   	pop    %es
   efddd:	1f                   	pop    %ds

; STRING @ 0xEFDDE, length 6: ]_^ZY[
   efdde:	5d                   	pop    %bp
   efddf:	5f                   	pop    %di
   efde0:	5e                   	pop    %si
   efde1:	5a                   	pop    %dx
   ...
   efdea:	75 01                	jne    0xefded    ; driver var 00EFh: transfer progress counter B
   efdec:	c3                   	ret

; STRING @ 0xEFDED, length 6: SQRVWU
   efded:	53                   	push   %bx
   efdee:	51                   	push   %cx
   efdef:	52                   	push   %dx
   efdf0:	56                   	push   %si
   ...
   efdf8:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   efdfc:	b0 90                	mov    $0x90,%al    ; Mitsumi command 90h: configure
   efdfe:	9c                   	pushf
   efdff:	fa                   	cli
   efe00:	ee                   	out    %al,(%dx)    ; OUT command byte 90h via [0061] path: configure | Hardware/port write
   efe01:	b0 02                	mov    $0x2,%al
   efe03:	ee                   	out    %al,(%dx)    ; Hardware/port write
   efe04:	eb 00                	jmp    0xefe06    ; driver var 00EFh: transfer progress counter B
   efe06:	b0 01                	mov    $0x1,%al
   efe08:	ee                   	out    %al,(%dx)    ; Hardware/port write
   efe09:	9d                   	popf
   efe0a:	e8 3f 0b             	call   0xe094c
   efe0d:	e8 cd 0a             	call   0xe08dd
   efe10:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   efe14:	b0 90                	mov    $0x90,%al    ; Mitsumi command 90h: configure
   efe16:	9c                   	pushf
   efe17:	fa                   	cli
   efe18:	ee                   	out    %al,(%dx)    ; OUT command byte 90h via [0061] path: configure | Hardware/port write
   efe19:	b0 08                	mov    $0x8,%al
   efe1b:	ee                   	out    %al,(%dx)    ; Hardware/port write
   efe1c:	eb 00                	jmp    0xefe1e    ; driver var 00EFh: transfer progress counter B
   efe1e:	b0 48                	mov    $0x48,%al
   efe20:	ee                   	out    %al,(%dx)    ; Hardware/port write
   efe21:	9d                   	popf
   efe22:	e8 27 0b             	call   0xe094c
   efe25:	e8 b5 0a             	call   0xe08dd
   efe28:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   efe2c:	b0 90                	mov    $0x90,%al    ; Mitsumi command 90h: configure
   efe2e:	9c                   	pushf
   efe2f:	fa                   	cli
   efe30:	ee                   	out    %al,(%dx)    ; OUT command byte 90h via [0061] path: configure | Hardware/port write
   efe31:	b0 01                	mov    $0x1,%al
   efe33:	ee                   	out    %al,(%dx)    ; Hardware/port write
   efe34:	eb 00                	jmp    0xefe36    ; driver var 00EFh: transfer progress counter B
   efe36:	b0 08                	mov    $0x8,%al
   efe38:	ee                   	out    %al,(%dx)    ; Hardware/port write
   efe39:	eb 00                	jmp    0xefe3b    ; driver var 00EFh: transfer progress counter B
   efe3b:	b0 0f                	mov    $0xf,%al
   efe3d:	ee                   	out    %al,(%dx)    ; Hardware/port write
   efe3e:	9d                   	popf
   efe3f:	e8 0a 0b             	call   0xe094c
   efe42:	e8 98 0a             	call   0xe08dd
   efe45:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   efe49:	b0 50                	mov    $0x50,%al    ; Mitsumi command 50h: set drive mode
   efe4b:	9c                   	pushf
   efe4c:	fa                   	cli
   efe4d:	ee                   	out    %al,(%dx)    ; OUT command byte 50h via [0061] path: set drive mode | Hardware/port write
   efe4e:	b0 c1                	mov    $0xc1,%al
   efe50:	ee                   	out    %al,(%dx)    ; Hardware/port write
   efe51:	9d                   	popf
   efe52:	e8 f7 0a             	call   0xe094c
   efe55:	07                   	pop    %es
   efe56:	1f                   	pop    %ds

; STRING @ 0xEFE57, length 6: ]_^ZY[
   efe57:	5d                   	pop    %bp
   efe58:	5f                   	pop    %di
   efe59:	5e                   	pop    %si
   efe5a:	5a                   	pop    %dx
   ...
   efe69:	76 03                	jbe    0xefe6e    ; driver var 00EFh: transfer progress counter B
   efe6b:	43                   	inc    %bx
   efe6c:	eb f9                	jmp    0xefe67    ; driver var 00EFh: transfer progress counter B
...
; ---------------------------------------------------------------------------
; request_82_position_status_msf @ 0xEFE93
; Extended request 82h: position/status with MSF fields.
; ---------------------------------------------------------------------------
   efe93:	e8 fa ff             	call   0xefe90    ; driver var 00EFh: transfer progress counter B
   efe96:	3c 01                	cmp    $0x1,%al
   efe98:	74 03                	je     0xefe9d    ; driver var 00EFh: transfer progress counter B
   efe9a:	e9 5c 01             	jmp    0xefff9    ; driver var 00EFh: transfer progress counter B
   efe9d:	80 3e f4 04 00       	cmpb   $0x0,0x4f4
   efea2:	74 18                	je     0xefebc    ; driver var 00EFh: transfer progress counter B
   efea4:	53                   	push   %bx
   efea5:	06                   	push   %es
   ...
   efeb0:	74 e8                	je     0xefe9a    ; driver var 00EFh: transfer progress counter B
   efeb2:	3c ff                	cmp    $0xff,%al
   efeb4:	74 e4                	je     0xefe9a    ; driver var 00EFh: transfer progress counter B
   efeb6:	e8 71 fe             	call   0xefd2a    ; driver var 00EFh: transfer progress counter B
   efeb9:	e8 29 ff             	call   0xefde5    ; driver var 00EFh: transfer progress counter B
   ...
   efed8:	75 08                	jne    0xefee2    ; driver var 00EFh: transfer progress counter B
   efeda:	05 96 00             	add    $0x96,%ax
   efedd:	83 d2 00             	adc    $0x0,%dx
   efee0:	eb 12                	jmp    0xefef4    ; driver var 00EFh: transfer progress counter B
   efee2:	26 80 7f 0d 01       	cmpb   $0x1,%es:0xd(%bx)
   efee7:	74 08                	je     0xefef1    ; driver var 00EFh: transfer progress counter B
   efee9:	5b                   	pop    %bx
   efeea:	07                   	pop    %es
   efeeb:	b8 03 80             	mov    $0x8003,%ax
   efeee:	e9 9c db             	jmp    0xeda8d    ; driver var 00EDh: transfer progress counter A
   ...
   eff0a:	a2 69 00             	mov    %al,0x69    ; driver var 0069h: MSF minute
   eff0d:	8a c5                	mov    %ch,%al
   eff0f:	e8 0c 08             	call   0xe071e
   eff12:	a2 6a 00             	mov    %al,0x6a    ; driver var 006Ah: MSF second
   eff15:	8a c1                	mov    %cl,%al
   eff17:	e8 04 08             	call   0xe071e
   eff1a:	a2 6b 00             	mov    %al,0x6b    ; driver var 006Bh: MSF frame
   eff1d:	5b                   	pop    %bx
   eff1e:	07                   	pop    %es
   eff1f:	c6 06 6c 00 00       	movb   $0x0,0x6c    ; driver var 006Ch: secondary MSF/count byte
   eff24:	c6 06 6d 00 00       	movb   $0x0,0x6d    ; driver var 006Dh: secondary MSF/count byte
   eff29:	c6 06 6e 00 00       	movb   $0x0,0x6e    ; driver var 006Eh: secondary MSF/count byte
   eff2e:	c6 06 f8 00 01       	movb   $0x1,0xf8
   eff33:	c7 06 ed 00 00 00    	movw   $0x0,0xed    ; driver var 00EDh: transfer progress counter A
   eff39:	c7 06 ef 00 00 00    	movw   $0x0,0xef    ; driver var 00EFh: transfer progress counter B
   eff3f:	e8 df f0             	call   0xef021    ; driver var 00EFh: transfer progress counter B
   eff42:	3c 00                	cmp    $0x0,%al
   eff44:	74 03                	je     0xeff49    ; driver var 00EFh: transfer progress counter B
   eff46:	e9 b0 00             	jmp    0xefff9    ; driver var 00EFh: transfer progress counter B
   eff49:	e8 91 09             	call   0xe08dd
   eff4c:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   eff51:	c7 06 fc 00 08 07    	movw   $0x708,0xfc    ; Mitsumi command 70h: hold/pause
   eff57:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   eff5b:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   eff5d:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
   eff5e:	eb 00                	jmp    0xeff60    ; driver var 00EFh: transfer progress counter B
   eff60:	e8 e9 09             	call   0xe094c
   eff63:	3c ff                	cmp    $0xff,%al
   eff65:	75 11                	jne    0xeff78    ; driver var 00EFh: transfer progress counter B
   eff67:	fe 0e c8 03          	decb   0x3c8
   eff6b:	75 e4                	jne    0xeff51    ; driver var 00EFh: transfer progress counter B
   eff6d:	e8 73 dd             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   eff70:	c6 06 b0 03 03       	movb   $0x3,0x3b0
   eff75:	e9 87 00             	jmp    0xeffff    ; driver var 00EFh: transfer progress counter B
   eff78:	8a c3                	mov    %bl,%al
   eff7a:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   eff7c:	75 02                	jne    0xeff80    ; driver var 00EFh: transfer progress counter B
   eff7e:	eb 79                	jmp    0xefff9    ; driver var 00EFh: transfer progress counter B
   eff80:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   eff82:	74 2d                	je     0xeffb1    ; driver var 00EFh: transfer progress counter B
   eff84:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   eff89:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   eff8e:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   eff93:	e8 47 09             	call   0xe08dd
   eff96:	e8 19 f0             	call   0xeefb2
   eff99:	3c ff                	cmp    $0xff,%al
   eff9b:	75 03                	jne    0xeffa0    ; driver var 00EFh: transfer progress counter B
   eff9d:	e9 38 fc             	jmp    0xefbd8    ; driver var 00EFh: transfer progress counter B
   effa0:	3c 01                	cmp    $0x1,%al
   effa2:	75 03                	jne    0xeffa7    ; driver var 00EFh: transfer progress counter B
   effa4:	e9 5b fc             	jmp    0xefc02    ; driver var 00EFh: transfer progress counter B
   effa7:	e8 80 fd             	call   0xefd2a    ; driver var 00EFh: transfer progress counter B
   effaa:	e8 38 fe             	call   0xefde5    ; driver var 00EFh: transfer progress counter B
   effad:	8a 1e 06 01          	mov    0x106,%bl
   effb1:	8a c3                	mov    %bl,%al
   effb3:	a8 08                	test   $0x8,%al
   effb5:	74 03                	je     0xeffba    ; driver var 00EFh: transfer progress counter B
   effb7:	e9 e2 db             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   effba:	8a c3                	mov    %bl,%al
   effbc:	a8 02                	test   $0x2,%al
   effbe:	74 03                	je     0xeffc3    ; driver var 00EFh: transfer progress counter B
   effc0:	e9 c7 da             	jmp    0xeda8a    ; driver var 00EDh: transfer progress counter A
   effc3:	e8 6b 07             	call   0xe0731
   effc6:	3c 2d                	cmp    $0x2d,%al
   effc8:	74 02                	je     0xeffcc    ; driver var 00EFh: transfer progress counter B
   effca:	eb 30                	jmp    0xefffc    ; driver var 00EFh: transfer progress counter B
   ...
   effdc:	75 10                	jne    0xeffee    ; driver var 00EFh: transfer progress counter B
   effde:	fe 0e c8 03          	decb   0x3c8
   effe2:	75 f0                	jne    0xeffd4    ; driver var 00EFh: transfer progress counter B
   effe4:	e8 fc dc             	call   0xedce3    ; driver var 00EDh: transfer progress counter A
   effe7:	c6 06 b0 03 04       	movb   $0x4,0x3b0
   effec:	eb 11                	jmp    0xeffff    ; driver var 00EFh: transfer progress counter B
   effee:	8a c3                	mov    %bl,%al

; STRING @ 0xEFFF0, length 5: $@<@u
   efff0:	24 40                	and    $0x40,%al    ; Mitsumi command 40h: status
   efff2:	3c 40                	cmp    $0x40,%al    ; Mitsumi command 40h: status
   efff4:	75 03                	jne    0xefff9    ; driver var 00EFh: transfer progress counter B
   efff6:	e9 a3 db             	jmp    0xedb9c    ; driver var 00EDh: transfer progress counter A
   efff9:	e9 21 e1             	jmp    0xee11d
   efffc:	e9 b0 ee             	jmp    0xeeeaf
   effff:	e8 74 01             	call   0xf0176
   f0002:	3c 01                	cmp    $0x1,%al
   f0004:	74 f3                	je     0xefff9    ; driver var 00EFh: transfer progress counter B
   f0006:	8a c3                	mov    %bl,%al
   f0008:	e9 6d ff             	jmp    0xfff78
   f000b:	e9 03 e1             	jmp    0xfe111

; ---------------------------------------------------------------------------
; request_83_compact_position_status @ 0xF000E
; Extended request 83h: compact position/status request.
; ---------------------------------------------------------------------------
   ...
   f007e:	a2 69 00             	mov    %al,0x69    ; driver var 0069h: MSF minute
   f0081:	8a c5                	mov    %ch,%al
   f0083:	e8 98 06             	call   0xf071e
   f0086:	a2 6a 00             	mov    %al,0x6a    ; driver var 006Ah: MSF second
   f0089:	8a c1                	mov    %cl,%al
   f008b:	e8 90 06             	call   0xf071e
   f008e:	a2 6b 00             	mov    %al,0x6b    ; driver var 006Bh: MSF frame
   f0091:	5b                   	pop    %bx
   f0092:	07                   	pop    %es
   f0093:	c6 06 6c 00 00       	movb   $0x0,0x6c    ; driver var 006Ch: secondary MSF/count byte
   f0098:	c6 06 6d 00 00       	movb   $0x0,0x6d    ; driver var 006Dh: secondary MSF/count byte
   f009d:	c6 06 6e 00 00       	movb   $0x0,0x6e    ; driver var 006Eh: secondary MSF/count byte
   f00a2:	c6 06 f8 00 01       	movb   $0x1,0xf8
   f00a7:	c7 06 ed 00 00 00    	movw   $0x0,0xed    ; driver var 00EDh: transfer progress counter A
   f00ad:	c7 06 ef 00 00 00    	movw   $0x0,0xef    ; driver var 00EFh: transfer progress counter B
   f00b3:	e8 6b ef             	call   0xff021
   f00b6:	3c 00                	cmp    $0x0,%al
   f00b8:	74 03                	je     0xf00bd
   f00ba:	e9 a7 00             	jmp    0xf0164
   f00bd:	c7 06 fc 00 08 07    	movw   $0x708,0xfc    ; Mitsumi command 70h: hold/pause
   f00c3:	e8 17 08             	call   0xf08dd
   f00c6:	c6 06 c8 03 03       	movb   $0x3,0x3c8
   f00cb:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f00cf:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   f00d1:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
   ...
   f00eb:	90                   	nop
   f00ec:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f00f0:	ec                   	in     (%dx),%al    ; Hardware/port read
   f00f1:	8a d8                	mov    %al,%bl
   f00f3:	8a c3                	mov    %bl,%al

; STRING @ 0xF00F5, length 5: $@<@t
   f00f5:	24 40                	and    $0x40,%al    ; Mitsumi command 40h: status
   f00f7:	3c 40                	cmp    $0x40,%al    ; Mitsumi command 40h: status
   f00f9:	74 02                	je     0xf00fd
   f00fb:	eb 67                	jmp    0xf0164
   f00fd:	8a c3                	mov    %bl,%al

; STRING @ 0xF00FF, length 6: $ < u)
   f00ff:	24 20                	and    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f0101:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f0103:	75 29                	jne    0xf012e
   f0105:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   f010a:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
...
; STRING @ 0xF015B, length 5: $@<@u
   f015b:	24 40                	and    $0x40,%al    ; Mitsumi command 40h: status
   f015d:	3c 40                	cmp    $0x40,%al    ; Mitsumi command 40h: status
   ...
   f0180:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0184:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   f0186:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
...
; ---------------------------------------------------------------------------
; request_84_range_command @ 0xF01A0
; Extended request 84h: range command / range-transfer candidate.
; ---------------------------------------------------------------------------
...
```
# 09 f0200 f07ff handlers 84 85 88 msf
...
Handler 84h continuation, 85h, 88h, MSF helpers.

## Local labels and strings

```text
0xF051A  request_85_media_status_location: Extended request 85h: media/status/current-location candidate.
0xF0652  request_88_media_ready_change_gate: Extended request 88h: media ready/change gate.
0xF070F  msf_conversion_helper: Converts logical sector/frame count to minute/second/frame components.
0xF071E  bcd_conversion_helper: Converts a binary value into BCD-like byte for Mitsumi packet.
0xF037D  string[6]: $ < u-
0xF04E2  string[5]: $@<@u
0xF04EA  string[5]: $ < t
0xF0557  string[5]: $ < u
...
```asm
   ...
   f021e:	a2 69 00             	mov    %al,0x69    ; driver var 0069h: MSF minute
   f0221:	8a c5                	mov    %ch,%al
   f0223:	e8 f8 04             	call   0xf071e
   f0226:	a2 6a 00             	mov    %al,0x6a    ; driver var 006Ah: MSF second
   f0229:	8a c1                	mov    %cl,%al
   f022b:	e8 f0 04             	call   0xf071e
   f022e:	a2 6b 00             	mov    %al,0x6b    ; driver var 006Bh: MSF frame
   ...
   f0263:	a2 6c 00             	mov    %al,0x6c    ; driver var 006Ch: secondary MSF/count byte
   f0266:	8a c5                	mov    %ch,%al
   f0268:	e8 b3 04             	call   0xf071e
   f026b:	a2 6d 00             	mov    %al,0x6d    ; driver var 006Dh: secondary MSF/count byte
   f026e:	8a c1                	mov    %cl,%al
   f0270:	e8 ab 04             	call   0xf071e
   f0273:	a2 6e 00             	mov    %al,0x6e    ; driver var 006Eh: secondary MSF/count byte
   f0276:	5b                   	pop    %bx
   f0277:	07                   	pop    %es
   ...
   f02b3:	a2 69 00             	mov    %al,0x69    ; driver var 0069h: MSF minute
   f02b6:	8a c5                	mov    %ch,%al
   f02b8:	e8 63 04             	call   0xf071e
   f02bb:	a2 6a 00             	mov    %al,0x6a    ; driver var 006Ah: MSF second
   f02be:	8a c1                	mov    %cl,%al
   f02c0:	e8 5b 04             	call   0xf071e
   f02c3:	a2 6b 00             	mov    %al,0x6b    ; driver var 006Bh: MSF frame
   ...
   f02f5:	a2 6c 00             	mov    %al,0x6c    ; driver var 006Ch: secondary MSF/count byte
   f02f8:	8a c5                	mov    %ch,%al
   f02fa:	e8 21 04             	call   0xf071e
   f02fd:	a2 6d 00             	mov    %al,0x6d    ; driver var 006Dh: secondary MSF/count byte
   f0300:	8a c1                	mov    %cl,%al
   f0302:	e8 19 04             	call   0xf071e
   f0305:	a2 6e 00             	mov    %al,0x6e    ; driver var 006Eh: secondary MSF/count byte
   ...
   f035a:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f035e:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   f0360:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
...
; STRING @ 0xF037D, length 6: $ < u-
   f037d:	24 20                	and    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f037f:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f0381:	75 2d                	jne    0xf03b0
   f0383:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   f0388:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ...
   f0409:	90                   	nop
   f040a:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f040e:	b0 50                	mov    $0x50,%al    ; Mitsumi command 50h: set drive mode
   f0410:	9c                   	pushf
   f0411:	fa                   	cli
   f0412:	ee                   	out    %al,(%dx)    ; OUT command byte 50h via [0061] path: set drive mode | Hardware/port write
   f0413:	b0 00                	mov    $0x0,%al
   f0415:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0416:	9d                   	popf
   f0417:	e8 32 05             	call   0xf094c
   f041a:	3c ff                	cmp    $0xff,%al
   f041c:	75 03                	jne    0xf0421
   f041e:	e9 fc dc             	jmp    0xfe11d
   f0421:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0425:	b0 c0                	mov    $0xc0,%al    ; Mitsumi command C0h: read sector(s)
   f0427:	9c                   	pushf
   f0428:	fa                   	cli
   f0429:	ee                   	out    %al,(%dx)    ; OUT command byte C0h via [0061] path: read sectors | Hardware/port write
   f042a:	a0 69 00             	mov    0x69,%al    ; driver var 0069h: MSF minute
   f042d:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f042e:	eb 00                	jmp    0xf0430
   f0430:	a0 6a 00             	mov    0x6a,%al    ; driver var 006Ah: MSF second
   f0433:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0434:	eb 00                	jmp    0xf0436
   f0436:	a0 6b 00             	mov    0x6b,%al    ; driver var 006Bh: MSF frame
   f0439:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f043a:	eb 00                	jmp    0xf043c
   f043c:	b0 00                	mov    $0x0,%al
   f043e:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f043f:	eb 00                	jmp    0xf0441
   f0441:	b0 00                	mov    $0x0,%al
   f0443:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0444:	eb 00                	jmp    0xf0446
   f0446:	b0 00                	mov    $0x0,%al
   f0448:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0449:	9d                   	popf
   f044a:	e8 ff 04             	call   0xf094c
   f044d:	3c ff                	cmp    $0xff,%al
   f044f:	75 03                	jne    0xf0454
   f0451:	e9 c9 dc             	jmp    0xfe11d
   f0454:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0458:	b0 50                	mov    $0x50,%al    ; Mitsumi command 50h: set drive mode
   f045a:	9c                   	pushf
   f045b:	fa                   	cli
   f045c:	ee                   	out    %al,(%dx)    ; OUT command byte 50h via [0061] path: set drive mode | Hardware/port write
   f045d:	b0 01                	mov    $0x1,%al
   f045f:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0460:	9d                   	popf
   ...
   f0476:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   f047a:	bb 28 23             	mov    $0x2328,%bx
   f047d:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f04a3:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f04a7:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f04be:	24 f8                	and    $0xf8,%al    ; Mitsumi command F8h: close tray
...
; STRING @ 0xF04E2, length 5: $@<@u
   f04e2:	24 40                	and    $0x40,%al    ; Mitsumi command 40h: status
   f04e4:	3c 40                	cmp    $0x40,%al    ; Mitsumi command 40h: status
   f04e6:	75 08                	jne    0xf04f0
   f04e8:	8a c3                	mov    %bl,%al

; STRING @ 0xF04EA, length 5: $ < t
   f04ea:	24 20                	and    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f04ec:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ...
   f050d:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   f0512:	c6 06 a8 03 01       	movb   $0x1,0x3a8
   f0517:	e9 e2 f6             	jmp    0xffbfc

; ---------------------------------------------------------------------------
; request_85_media_status_location @ 0xF051A
; Extended request 85h: media/status/current-location candidate.
; ---------------------------------------------------------------------------
   ...
   f053a:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f053e:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   f0540:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
...
; STRING @ 0xF0557, length 5: $ < u
   f0557:	24 20                	and    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f0559:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f055b:	75 0f                	jne    0xf056c
   f055d:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   f0562:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ...
   f0582:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0586:	b0 70                	mov    $0x70,%al    ; Mitsumi command 70h: hold/pause
   f0588:	ee                   	out    %al,(%dx)    ; OUT command byte 70h via [0061] path: hold/pause | Hardware/port write
   ...
   f05b5:	a0 6c 00             	mov    0x6c,%al    ; driver var 006Ch: secondary MSF/count byte
   f05b8:	a2 90 00             	mov    %al,0x90
   f05bb:	a0 6d 00             	mov    0x6d,%al    ; driver var 006Dh: secondary MSF/count byte
   f05be:	a2 91 00             	mov    %al,0x91
   f05c1:	a0 6e 00             	mov    0x6e,%al    ; driver var 006Eh: secondary MSF/count byte
   ...
   f05f7:	a2 69 00             	mov    %al,0x69    ; driver var 0069h: MSF minute
   f05fa:	a0 9f 00             	mov    0x9f,%al
   f05fd:	a2 6a 00             	mov    %al,0x6a    ; driver var 006Ah: MSF second
   f0600:	a0 a0 00             	mov    0xa0,%al
   f0603:	a2 6b 00             	mov    %al,0x6b    ; driver var 006Bh: MSF frame
   ...
   f063f:	a2 69 00             	mov    %al,0x69    ; driver var 0069h: MSF minute
   f0642:	a2 6a 00             	mov    %al,0x6a    ; driver var 006Ah: MSF second
   f0645:	a2 6b 00             	mov    %al,0x6b    ; driver var 006Bh: MSF frame
   f0648:	a2 6c 00             	mov    %al,0x6c    ; driver var 006Ch: secondary MSF/count byte
   f064b:	a2 6d 00             	mov    %al,0x6d    ; driver var 006Dh: secondary MSF/count byte
   f064e:	a2 6e 00             	mov    %al,0x6e    ; driver var 006Eh: secondary MSF/count byte
   f0651:	c3                   	ret

; ---------------------------------------------------------------------------
; request_88_media_ready_change_gate @ 0xF0652
; Extended request 88h: media ready/change gate.
; ---------------------------------------------------------------------------
   ...
   f06a1:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f06a5:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   f06a7:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
...
; STRING @ 0xF06B3, length 5: $ < u
   f06b3:	24 20                	and    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f06b5:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f06b7:	75 1d                	jne    0xf06d6
   f06b9:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   f06be:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ...
   f06f7:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
...
; ---------------------------------------------------------------------------
; msf_conversion_helper @ 0xF070F
; Converts logical sector/frame count to minute/second/frame components.
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
; bcd_conversion_helper @ 0xF071E
; Converts a binary value into BCD-like byte for Mitsumi packet.
; ---------------------------------------------------------------------------
   f071e:	53                   	push   %bx
   f071f:	d4 0a                	aam    $0xa
   f0721:	50                   	push   %ax
   ...
   f076f:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0773:	b0 20                	mov    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f0775:	ee                   	out    %al,(%dx)    ; OUT command byte 20h via [0061] path: sub-Q | Hardware/port write
   ...
   f0784:	f6 c3 40             	test   $0x40,%bl    ; Mitsumi command 40h: status
   ...
   f07ff:	c3                   	ret
```
# 10 f0800 f0cff packet status transfer helpers
...
C0 packet helper, status/data helper, transfer/interrupt helpers.

## Local labels and strings

```text
0xF08AB  general_c0_packet_helper: Sends generalized C0 [0069] [006A] [006B] [006C] [006D] [006E] packet.
0xF094C  status_data_read_helper: Polls status/phase and reads response/status byte from command/data port.
0xF0CD9  init_handler: INIT handler. Parses embedded command line and registers driver.
0xF0A17  string[4]: PSQR
0xF0CD3  string[4]: ZY[X
0xF0CF1  string[11]: <\rt@<\nt<</u
```
...
```asm
   ...
   f081a:	c3                   	ret
   f081b:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f081f:	b0 10                	mov    $0x10,%al    ; Mitsumi command 10h: TOC/disk info candidate
   f0821:	ee                   	out    %al,(%dx)    ; OUT command byte 10h via [0061] path: TOC/disk info | Hardware/port write
   ...
   f0830:	f6 c3 40             	test   $0x40,%bl    ; Mitsumi command 40h: status
   f0833:	75 03                	jne    0xf0838
   f0835:	b0 01                	mov    $0x1,%al
   f0837:	c3                   	ret
   f0838:	f6 c3 20             	test   $0x20,%bl    ; Mitsumi command 20h: sub-Q candidate
   f083b:	74 0b                	je     0xf0848
   f083d:	b0 01                	mov    $0x1,%al
   f083f:	a2 a8 03             	mov    %al,0x3a8
   f0842:	a2 01 05             	mov    %al,0x501    ; driver var 0501h: media/attention state
...
; ---------------------------------------------------------------------------
; general_c0_packet_helper @ 0xF08AB
; Sends generalized C0 [0069] [006A] [006B] [006C] [006D] [006E] packet.
; ---------------------------------------------------------------------------
   f08ab:	c6 06 08 05 00       	movb   $0x0,0x508
   f08b0:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f08b4:	b0 c0                	mov    $0xc0,%al    ; Mitsumi command C0h: read sector(s)
   f08b6:	9c                   	pushf
   f08b7:	fa                   	cli
   f08b8:	ee                   	out    %al,(%dx)    ; OUT command byte C0h via [0061] path: read sectors | Hardware/port write
   f08b9:	a0 69 00             	mov    0x69,%al    ; driver var 0069h: MSF minute
   f08bc:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f08bd:	eb 00                	jmp    0xf08bf
   f08bf:	a0 6a 00             	mov    0x6a,%al    ; driver var 006Ah: MSF second
   f08c2:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f08c3:	eb 00                	jmp    0xf08c5
   f08c5:	a0 6b 00             	mov    0x6b,%al    ; driver var 006Bh: MSF frame
   f08c8:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f08c9:	eb 00                	jmp    0xf08cb
   f08cb:	a0 6c 00             	mov    0x6c,%al    ; driver var 006Ch: secondary MSF/count byte
   f08ce:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f08cf:	eb 00                	jmp    0xf08d1
   f08d1:	a0 6d 00             	mov    0x6d,%al    ; driver var 006Dh: secondary MSF/count byte
   f08d4:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f08d5:	eb 00                	jmp    0xf08d7
   f08d7:	a0 6e 00             	mov    0x6e,%al    ; driver var 006Eh: secondary MSF/count byte
   f08da:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f08db:	9d                   	popf
   f08dc:	c3                   	ret
   f08dd:	51                   	push   %cx
   f08de:	53                   	push   %bx
   ...
   f08e7:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   f08eb:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f08ff:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0903:	ec                   	in     (%dx),%al    ; Hardware/port read
   f0904:	a8 20                	test   $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f0906:	74 12                	je     0xf091a
   f0908:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   f090d:	c6 06 01 05 01       	movb   $0x1,0x501    ; driver var 0501h: media/attention state
   ...
   f0921:	c3                   	ret
   f0922:	51                   	push   %cx
   f0923:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   f0927:	bb 30 75             	mov    $0x7530,%bx
   f092a:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f093e:	59                   	pop    %cx
   f093f:	c3                   	ret
   f0940:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0944:	ec                   	in     (%dx),%al    ; Hardware/port read
...
; ---------------------------------------------------------------------------
; status_data_read_helper @ 0xF094C
; Polls status/phase and reads response/status byte from command/data port.
; ---------------------------------------------------------------------------
   f094c:	51                   	push   %cx
   f094d:	c6 06 03 05 01       	movb   $0x1,0x503
   f0952:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   f0956:	bb b8 0b             	mov    $0xbb8,%bx
   f0959:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f0974:	4a                   	dec    %dx
   f0975:	90                   	nop
   f0976:	ec                   	in     (%dx),%al    ; Hardware/port read
   f0977:	90                   	nop
   f0978:	42                   	inc    %dx    ; Hardware/port read
   ...
   f0996:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   f099a:	bb 30 00             	mov    $0x30,%bx
   f099d:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f09b1:	59                   	pop    %cx
   f09b2:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   f09b4:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f09b5:	90                   	nop
   f09b6:	90                   	nop
   f09b7:	c3                   	ret
   f09b8:	4a                   	dec    %dx
   f09b9:	90                   	nop
   f09ba:	ec                   	in     (%dx),%al    ; Hardware/port read
   f09bb:	90                   	nop
   f09bc:	42                   	inc    %dx    ; Hardware/port read
   ...
   f09d7:	b3 10                	mov    $0x10,%bl    ; Mitsumi command 10h: TOC/disk info candidate
   f09d9:	f6 f3                	div    %bl
   f09db:	50                   	push   %ax
...
; STRING @ 0xF0A17, length 4: PSQR
   ...
   f0a24:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   f0a28:	ec                   	in     (%dx),%al    ; Hardware/port read
   f0a29:	a8 08                	test   $0x8,%al
   f0a2b:	75 16                	jne    0xf0a43
   f0a2d:	4a                   	dec    %dx
   f0a2e:	e8 99 ff             	call   0xf09ca
   f0a31:	bb ff ff             	mov    $0xffff,%bx
   f0a34:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   f0a38:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f0a47:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0a4b:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f0a61:	5b                   	pop    %bx
   f0a62:	1f                   	pop    %ds
   f0a63:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0a67:	b0 41                	mov    $0x41,%al
   f0a69:	ee                   	out    %al,(%dx)    ; OUT command byte 41h via [0061] path: parameter/non-mcdx | Hardware/port write
   ...
   f0a86:	b1 20                	mov    $0x20,%cl    ; Mitsumi command 20h: sub-Q candidate
   f0a88:	bb ff ff             	mov    $0xffff,%bx
   f0a8b:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   f0a8f:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f0a9e:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0aa2:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f0b15:	8b 16 63 00          	mov    0x63,%dx    ; driver var 0063h: status/phase port candidate
   f0b19:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f0b2b:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0b2f:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f0b4a:	ec                   	in     (%dx),%al    ; Hardware/port read
   ...
   f0b5e:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ...
   f0b93:	8b 1e ef 00          	mov    0xef,%bx    ; driver var 00EFh: transfer progress counter B
   f0b97:	d0 e3                	shl    $1,%bl
   f0b99:	81 3e 01 01 30 09    	cmpw   $0x930,0x101    ; driver var 0101h: transfer-size limit
   f0b9f:	75 0f                	jne    0xf0bb0
   f0ba1:	8b bf 87 01          	mov    0x187(%bx),%di
   f0ba5:	b8 ff ff             	mov    $0xffff,%ax
   f0ba8:	83 c7 10             	add    $0x10,%di    ; Mitsumi command 10h: TOC/disk info candidate
   f0bab:	83 c7 0c             	add    $0xc,%di
   f0bae:	eb 0d                	jmp    0xf0bbd
   f0bb0:	8b bf 07 01          	mov    0x107(%bx),%di
   f0bb4:	b8 ff ff             	mov    $0xffff,%ax
   f0bb7:	83 c7 10             	add    $0x10,%di    ; Mitsumi command 10h: TOC/disk info candidate
   ...
   f0bd2:	1f                   	pop    %ds
   f0bd3:	07                   	pop    %es
   f0bd4:	a1 ef 00             	mov    0xef,%ax    ; driver var 00EFh: transfer progress counter B
   f0bd7:	40                   	inc    %ax
   f0bd8:	3b 06 fa 00          	cmp    0xfa,%ax    ; driver var 00FAh: sector/transfer count candidate
   f0bdc:	76 02                	jbe    0xf0be0
   f0bde:	32 c0                	xor    %al,%al
   f0be0:	a3 ef 00             	mov    %ax,0xef    ; driver var 00EFh: transfer progress counter B
   f0be3:	3b 06 ed 00          	cmp    0xed,%ax    ; driver var 00EDh: transfer progress counter A
   ...
   f0bff:	a1 ef 00             	mov    0xef,%ax    ; driver var 00EFh: transfer progress counter B
   f0c02:	3c 00                	cmp    $0x0,%al
   f0c04:	74 08                	je     0xf0c0e
   f0c06:	fe c8                	dec    %al
   f0c08:	a3 ef 00             	mov    %ax,0xef    ; driver var 00EFh: transfer progress counter B
   f0c0b:	e9 a4 00             	jmp    0xf0cb2
   f0c0e:	a1 fa 00             	mov    0xfa,%ax    ; driver var 00FAh: sector/transfer count candidate
   f0c11:	a3 ef 00             	mov    %ax,0xef    ; driver var 00EFh: transfer progress counter B
   f0c14:	e9 9b 00             	jmp    0xf0cb2
   f0c17:	c6 06 f8 00 00       	movb   $0x0,0xf8
   f0c1c:	8b 1e ef 00          	mov    0xef,%bx    ; driver var 00EFh: transfer progress counter B
   f0c20:	d0 e3                	shl    $1,%bl
   f0c22:	81 3e 01 01 30 09    	cmpw   $0x930,0x101    ; driver var 0101h: transfer-size limit
   ...
   f0c48:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   f0c4a:	8b 16 5f 00          	mov    0x5f,%dx
   f0c4e:	83 c2 0f             	add    $0xf,%dx
   f0c51:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0c52:	eb 00                	jmp    0xf0c54
   f0c54:	a1 01 01             	mov    0x101,%ax    ; driver var 0101h: transfer-size limit
   f0c57:	3d 00 08             	cmp    $0x800,%ax
   f0c5a:	75 0a                	jne    0xf0c66
   f0c5c:	80 3e bf 03 00       	cmpb   $0x0,0x3bf
   f0c61:	74 03                	je     0xf0c66
   f0c63:	05 10 00             	add    $0x10,%ax    ; Mitsumi command 10h: TOC/disk info candidate
   f0c66:	d1 e8                	shr    $1,%ax
   f0c68:	48                   	dec    %ax
   f0c69:	ba c6 00             	mov    $0xc6,%dx    ; driver var 00C6h: IRQ/vector selector
   f0c6c:	e6 d8                	out    %al,$0xd8    ; Hardware/port write
   f0c6e:	eb 00                	jmp    0xf0c70
   f0c70:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0c71:	eb 00                	jmp    0xf0c73
   f0c73:	8a c4                	mov    %ah,%al
   f0c75:	ee                   	out    %al,(%dx)    ; Hardware/port write
   ...
   f0c8f:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0c90:	eb 00                	jmp    0xf0c92
   f0c92:	8a c4                	mov    %ah,%al
   f0c94:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0c95:	eb 00                	jmp    0xf0c97
   f0c97:	ba 8b 00             	mov    $0x8b,%dx
   f0c9a:	b0 10                	mov    $0x10,%al    ; Mitsumi command 10h: TOC/disk info candidate
   f0c9c:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0c9d:	eb 00                	jmp    0xf0c9f
   f0c9f:	b0 45                	mov    $0x45,%al
   f0ca1:	ba d6 00             	mov    $0xd6,%dx
   f0ca4:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0ca5:	eb 00                	jmp    0xf0ca7
   f0ca7:	b0 01                	mov    $0x1,%al
   f0ca9:	ba d4 00             	mov    $0xd4,%dx
   f0cac:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f0cad:	eb 00                	jmp    0xf0caf
   f0caf:	eb 01                	jmp    0xf0cb2
   f0cb1:	90                   	nop
   f0cb2:	80 3e f7 00 01       	cmpb   $0x1,0xf7
   f0cb7:	74 10                	je     0xf0cc9
   f0cb9:	2e a0 c6 00          	mov    %cs:0xc6,%al    ; driver var 00C6h: IRQ/vector selector
   f0cbd:	3c 0b                	cmp    $0xb,%al
   f0cbf:	75 04                	jne    0xf0cc5
   f0cc1:	b0 20                	mov    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f0cc3:	e6 a0                	out    %al,$0xa0    ; Hardware/port write
   f0cc5:	b0 20                	mov    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f0cc7:	e6 20                	out    %al,$0x20    ; Mitsumi command 20h: sub-Q candidate | Hardware/port write
...
; ---------------------------------------------------------------------------
; init_handler @ 0xF0CD9
; INIT handler. Parses embedded command line and registers driver.
; ---------------------------------------------------------------------------
...
```
# 11 f0d00 f14bf init parser strings
...
INIT parser, option handlers, strings/version area.

## Local labels and strings

```text
0xF1073  parse_option_P: Parses /P option. No durable base-port assignment confirmed in this ROM path.
0xF107F  parse_option_D: Parses /D option. Copies device name into DOS device header.
0xF10B9  parse_option_T: Parses /T option. Durable effect not confirmed.
0xF10D7  parse_option_I: Parses /I option. Selects IRQ/vector state.
0xF1164  parse_option_M: Parses /M option. Sets buffer/count state.
0xF11ED  parse_option_U: Parses /U option. Door lock/unlock behavior.
0xF126A  parse_option_A: Parses /A option. Alternate feature flag.
0xF12A2  parse_option_H: Parses /H option. Probes INT 2Fh host/hardware service.
0xF14A2  version_string: Version string: GRYPHON CD-ROM device driver - Version is 2(33) 29-Sep-92
0xF0D03  string[48]: <Pt0<Dt5<Tt:<It?<MtD<UtI<AtS<NtX<Ht\<\rt^<\ntZ<^tV
0xF0DAD  string[4]: PSRU
0xF0EA8  string[4]: ]Z[X
0xF0EFC  string[4]: SPR2
0xF0F33  string[4]: SRP2
0xF0F8B  string[7]: <3t\n<2t
0xF1083  string[15]: </t(< t$<\rt <:u
0xF109E  string[8]: <\rt\r<\nt	
0xF10DB  string[15]: </t:< t6<\rt2<:u
0xF10EF  string[15]: <4t)<5t7<7tE<1u
0xF1103  string[4]: <1tK
0xF1168  string[15]: </t5< t1<\rt-<:u
0xF1189  string[5]: < t\n<
0xF11F1  string[15]: </t(< t$<\rt <:u
0xF126E  string[15]: </t(< t$<\rt <:u
0xF1327  string[4]: &;7u
0xF1447  string[5]: =DCtN
0xF14A0  string[32]: \r\nGRYPHON CD-ROM device driver -
```
...
; STRING @ 0xF0D03, length 48: <Pt0<Dt5<Tt:<It?<MtD<UtI<AtS<NtX<Ht\<\rt^<\ntZ<^tV
   f0d03:	3c 50                	cmp    $0x50,%al    ; Mitsumi command 50h: set drive mode
   ...
   f0d90:	3a 06 cb 00          	cmp    0xcb,%al    ; driver var 00CBh: buffer count
   f0d94:	76 05                	jbe    0xf0d9b
   f0d96:	c6 06 c3 03 00       	movb   $0x0,0x3c3
   f0d9b:	e8 60 05             	call   0xf12fe
   f0d9e:	c6 06 f4 04 01       	movb   $0x1,0x4f4
   f0da3:	50                   	push   %ax
   f0da4:	a1 cd 00             	mov    0xcd,%ax    ; driver var 00CDh: transfer count base
   f0da7:	48                   	dec    %ax
   f0da8:	a3 fa 00             	mov    %ax,0xfa    ; driver var 00FAh: sector/transfer count candidate
   f0dab:	58                   	pop    %ax
   f0dac:	06                   	push   %es

; STRING @ 0xF0DAD, length 4: PSRU
   f0dad:	50                   	push   %ax
   f0dae:	53                   	push   %bx
   f0daf:	52                   	push   %dx
   f0db0:	55                   	push   %bp
   ...
   f0dbc:	a0 c6 00             	mov    0xc6,%al    ; driver var 00C6h: IRQ/vector selector
   ...
   f0dd1:	cd 21                	int    $0x21    ; DOS INT 21h service
   f0dd3:	eb 29                	jmp    0xf0dfe
   f0dd5:	90                   	nop
   f0dd6:	b0 0c                	mov    $0xc,%al
   f0dd8:	cd 21                	int    $0x21    ; DOS INT 21h service
   f0dda:	eb 22                	jmp    0xf0dfe
   f0ddc:	90                   	nop
   f0ddd:	b0 0d                	mov    $0xd,%al
   f0ddf:	cd 21                	int    $0x21    ; DOS INT 21h service
   f0de1:	eb 1b                	jmp    0xf0dfe
   f0de3:	90                   	nop
   f0de4:	b0 0f                	mov    $0xf,%al
   f0de6:	cd 21                	int    $0x21    ; DOS INT 21h service
   f0de8:	eb 14                	jmp    0xf0dfe
   f0dea:	90                   	nop
   f0deb:	b0 73                	mov    $0x73,%al
   f0ded:	cd 21                	int    $0x21    ; DOS INT 21h service
   f0def:	e4 a1                	in     $0xa1,%al
   f0df1:	22 06 c7 00          	and    0xc7,%al    ; driver var 00C7h: PIC mask value
   f0df5:	e6 a1                	out    %al,$0xa1    ; Hardware/port write
   f0df7:	a0 c8 00             	mov    0xc8,%al    ; driver var 00C8h: EOI/vector value
   f0dfa:	e6 a0                	out    %al,$0xa0    ; Hardware/port write
   f0dfc:	eb 0d                	jmp    0xf0e0b
   f0dfe:	e4 21                	in     $0x21,%al
   f0e00:	22 06 c7 00          	and    0xc7,%al    ; driver var 00C7h: PIC mask value
   f0e04:	e6 21                	out    %al,$0x21    ; Hardware/port write
   f0e06:	a0 c8 00             	mov    0xc8,%al    ; driver var 00C8h: EOI/vector value
   f0e09:	e6 20                	out    %al,$0x20    ; Mitsumi command 20h: sub-Q candidate | Hardware/port write
   f0e0b:	b8 30 09             	mov    $0x930,%ax
   f0e0e:	32 ff                	xor    %bh,%bh
   f0e10:	8a 1e cb 00          	mov    0xcb,%bl    ; driver var 00CBh: buffer count
   f0e14:	f7 e3                	mul    %bx
   ...
   f0e28:	80 3e 09 05 01       	cmpb   $0x1,0x509    ; driver var 0509h: /H host service mode
   f0e2d:	75 07                	jne    0xf0e36
   f0e2f:	bb 00 00             	mov    $0x0,%bx
   f0e32:	8b c3                	mov    %bx,%ax
   f0e34:	eb 0e                	jmp    0xf0e44
   f0e36:	80 3e 09 05 02       	cmpb   $0x2,0x509    ; driver var 0509h: /H host service mode
   f0e3b:	75 02                	jne    0xf0e3f
   f0e3d:	eb 00                	jmp    0xf0e3f
   f0e3f:	bb 4c 3c             	mov    $0x3c4c,%bx
   f0e42:	8c c8                	mov    %cs,%ax
   f0e44:	b9 00 00             	mov    $0x0,%cx
   f0e47:	8a 0e cb 00          	mov    0xcb,%cl    ; driver var 00CBh: buffer count
   f0e4b:	c7 06 01 01 30 09    	movw   $0x930,0x101    ; driver var 0101h: transfer-size limit
   f0e51:	c7 06 03 01 30 09    	movw   $0x930,0x103    ; driver var 0103h: transfer-size limit
   f0e57:	bd 00 00             	mov    $0x0,%bp
   f0e5a:	e8 34 d1             	call   0xfdf91
   f0e5d:	80 3e 09 05 01       	cmpb   $0x1,0x509    ; driver var 0509h: /H host service mode
   ...
   f0e77:	c7 06 01 01 00 08    	movw   $0x800,0x101    ; driver var 0101h: transfer-size limit
   f0e7d:	c7 06 03 01 10 08    	movw   $0x810,0x103    ; driver var 0103h: transfer-size limit
...
; STRING @ 0xF0EA8, length 4: ]Z[X
   ...
   f0eb0:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f0eb4:	b0 40                	mov    $0x40,%al    ; Mitsumi command 40h: status
   f0eb6:	ee                   	out    %al,(%dx)    ; OUT command byte 40h via [0061] path: status | Hardware/port write
   ...
   f0ec9:	a8 40                	test   $0x40,%al    ; Mitsumi command 40h: status
   ...
   f0ef2:	05 10 00             	add    $0x10,%ax    ; Mitsumi command 10h: TOC/disk info candidate
   f0ef5:	80 3e 09 05 01       	cmpb   $0x1,0x509    ; driver var 0509h: /H host service mode
   f0efa:	74 16                	je     0xf0f12

; STRING @ 0xF0EFC, length 4: SPR2
   f0efc:	53                   	push   %bx
   f0efd:	50                   	push   %ax
   f0efe:	52                   	push   %dx
   f0eff:	32 e4                	xor    %ah,%ah
   f0f01:	a0 cb 00             	mov    0xcb,%al    ; driver var 00CBh: buffer count
   f0f04:	fe c0                	inc    %al
   ...
   f0f1f:	80 c4 10             	add    $0x10,%ah    ; Mitsumi command 10h: TOC/disk info candidate
   f0f22:	26 89 47 10          	mov    %ax,%es:0x10(%bx)
   f0f26:	26 c6 47 01 00       	movb   $0x0,%es:0x1(%bx)
   f0f2b:	80 3e 09 05 01       	cmpb   $0x1,0x509    ; driver var 0509h: /H host service mode
   f0f30:	75 17                	jne    0xf0f49
   f0f32:	06                   	push   %es

; STRING @ 0xF0F33, length 4: SRP2
   f0f33:	53                   	push   %bx
   f0f34:	52                   	push   %dx
   f0f35:	50                   	push   %ax
   f0f36:	32 e4                	xor    %ah,%ah
   f0f38:	a0 cb 00             	mov    0xcb,%al    ; driver var 00CBh: buffer count
   ...
   f0f7b:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
...
; STRING @ 0xF0F8B, length 7: <3t\n<2t
   ...
   f0fdb:	04 90                	add    $0x90,%al    ; Mitsumi command 90h: configure
   ...
   f104d:	81 c3 08 04          	add    $0x408,%bx    ; Mitsumi command 40h: status
   f1051:	89 1e 61 00          	mov    %bx,0x61    ; driver var 0061h: command/data port candidate
   f1055:	8b d8                	mov    %ax,%bx
   f1057:	81 c3 09 04          	add    $0x409,%bx    ; Mitsumi command 40h: status
   f105b:	89 1e 63 00          	mov    %bx,0x63    ; driver var 0063h: status/phase port candidate
   f105f:	8b d8                	mov    %ax,%bx
   f1061:	81 c3 09 04          	add    $0x409,%bx    ; Mitsumi command 40h: status
   f1065:	89 1e 65 00          	mov    %bx,0x65
   f1069:	8b d8                	mov    %ax,%bx
   f106b:	81 c3 0a 04          	add    $0x40a,%bx    ; Mitsumi command 40h: status
   f106f:	89 1e 67 00          	mov    %bx,0x67

; ---------------------------------------------------------------------------
; parse_option_P @ 0xF1073
; Parses /P option. No durable base-port assignment confirmed in this ROM path.
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
; parse_option_D @ 0xF107F
; Parses /D option. Copies device name into DOS device header.
; ---------------------------------------------------------------------------
   f107f:	46                   	inc    %si
   f1080:	26 8a 04             	mov    %es:(%si),%al

; STRING @ 0xF1083, length 15: </t(< t$<\rt <:u
   f1083:	3c 2f                	cmp    $0x2f,%al
   f1085:	74 28                	je     0xf10af
   f1087:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ...
   f109a:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   f109c:	74 11                	je     0xf10af

; STRING @ 0xF109E, length 8: <\rt\r<\nt	
   ...
   f10ae:	c3                   	ret
   f10af:	b0 20                	mov    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
...
; ---------------------------------------------------------------------------
; parse_option_T @ 0xF10B9
; Parses /T option. Durable effect not confirmed.
; ---------------------------------------------------------------------------
   f10b9:	46                   	inc    %si
   f10ba:	26 8a 04             	mov    %es:(%si),%al
   f10bd:	3c 2f                	cmp    $0x2f,%al
   f10bf:	74 13                	je     0xf10d4
   f10c1:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
...
; ---------------------------------------------------------------------------
; parse_option_I @ 0xF10D7
; Parses /I option. Selects IRQ/vector state.
; ---------------------------------------------------------------------------
   f10d7:	46                   	inc    %si
   f10d8:	26 8a 04             	mov    %es:(%si),%al

; STRING @ 0xF10DB, length 15: </t:< t6<\rt2<:u
   f10db:	3c 2f                	cmp    $0x2f,%al
   f10dd:	74 3a                	je     0xf1119
   f10df:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
...
; STRING @ 0xF10EF, length 15: <4t)<5t7<7tE<1u
...
; STRING @ 0xF1103, length 4: <1tK
   f1103:	3c 31                	cmp    $0x31,%al
   f1105:	74 4b                	je     0xf1152
   f1107:	c6 06 c6 00 03       	movb   $0x3,0xc6    ; driver var 00C6h: IRQ/vector selector
   f110c:	c6 06 c8 00 63       	movb   $0x63,0xc8    ; driver var 0063h: status/phase port candidate | driver var 00C8h: EOI/vector value
   f1111:	c6 06 c7 00 f7       	movb   $0xf7,0xc7    ; driver var 00C7h: PIC mask value
   f1116:	b0 00                	mov    $0x0,%al
   f1118:	c3                   	ret
   f1119:	b0 01                	mov    $0x1,%al
   f111b:	c3                   	ret
   f111c:	c6 06 c6 00 04       	movb   $0x4,0xc6    ; driver var 00C6h: IRQ/vector selector
   f1121:	c6 06 c8 00 64       	movb   $0x64,0xc8    ; driver var 00C8h: EOI/vector value
   f1126:	c6 06 c7 00 ef       	movb   $0xef,0xc7    ; driver var 00C7h: PIC mask value | driver var 00EFh: transfer progress counter B
   f112b:	b0 00                	mov    $0x0,%al
   f112d:	c3                   	ret
   f112e:	c6 06 c6 00 05       	movb   $0x5,0xc6    ; driver var 00C6h: IRQ/vector selector
   f1133:	c6 06 c8 00 65       	movb   $0x65,0xc8    ; driver var 00C8h: EOI/vector value
   f1138:	c6 06 c7 00 df       	movb   $0xdf,0xc7    ; driver var 00C7h: PIC mask value
   f113d:	b0 00                	mov    $0x0,%al
   f113f:	c3                   	ret
   f1140:	c6 06 c6 00 07       	movb   $0x7,0xc6    ; driver var 00C6h: IRQ/vector selector
   f1145:	c6 06 c8 00 67       	movb   $0x67,0xc8    ; driver var 00C8h: EOI/vector value
   f114a:	c6 06 c7 00 7f       	movb   $0x7f,0xc7    ; driver var 00C7h: PIC mask value
   f114f:	b0 00                	mov    $0x0,%al
   f1151:	c3                   	ret
   f1152:	c6 06 c6 00 0b       	movb   $0xb,0xc6    ; driver var 00C6h: IRQ/vector selector
   f1157:	c6 06 c8 00 63       	movb   $0x63,0xc8    ; driver var 0063h: status/phase port candidate | driver var 00C8h: EOI/vector value
   f115c:	c6 06 c7 00 f7       	movb   $0xf7,0xc7    ; driver var 00C7h: PIC mask value
   f1161:	b0 00                	mov    $0x0,%al
   f1163:	c3                   	ret

; ---------------------------------------------------------------------------
; parse_option_M @ 0xF1164
; Parses /M option. Sets buffer/count state.
; ---------------------------------------------------------------------------
   f1164:	46                   	inc    %si
   f1165:	26 8a 04             	mov    %es:(%si),%al

; STRING @ 0xF1168, length 15: </t5< t1<\rt-<:u
   f1168:	3c 2f                	cmp    $0x2f,%al
   f116a:	74 35                	je     0xf11a1
   f116c:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
...
; STRING @ 0xF1189, length 5: < t\n<
   f1189:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ...
   f11e4:	a2 cb 00             	mov    %al,0xcb    ; driver var 00CBh: buffer count
   f11e7:	a3 cd 00             	mov    %ax,0xcd    ; driver var 00CDh: transfer count base
   f11ea:	b0 00                	mov    $0x0,%al
   f11ec:	c3                   	ret

; ---------------------------------------------------------------------------
; parse_option_U @ 0xF11ED
; Parses /U option. Door lock/unlock behavior.
; ---------------------------------------------------------------------------
   f11ed:	46                   	inc    %si
   f11ee:	26 8a 04             	mov    %es:(%si),%al

; STRING @ 0xF11F1, length 15: </t(< t$<\rt <:u
   f11f1:	3c 2f                	cmp    $0x2f,%al
   f11f3:	74 28                	je     0xf121d
   f11f5:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
   ...
   f1238:	8b 16 61 00          	mov    0x61,%dx    ; driver var 0061h: command/data port candidate
   f123c:	b0 fe                	mov    $0xfe,%al    ; Mitsumi command FEh: lock/unlock
   f123e:	9c                   	pushf
   f123f:	fa                   	cli
   f1240:	ee                   	out    %al,(%dx)    ; OUT command byte FEh via [0061] path: lock/unlock | Hardware/port write
   f1241:	a0 bd 03             	mov    0x3bd,%al
   f1244:	ee                   	out    %al,(%dx)    ; Hardware/port write
   f1245:	9d                   	popf
...
; ---------------------------------------------------------------------------
; parse_option_A @ 0xF126A
; Parses /A option. Alternate feature flag.
; ---------------------------------------------------------------------------
   f126a:	46                   	inc    %si
   f126b:	26 8a 04             	mov    %es:(%si),%al

; STRING @ 0xF126E, length 15: </t(< t$<\rt <:u
   f126e:	3c 2f                	cmp    $0x2f,%al
   f1270:	74 28                	je     0xf129a
   f1272:	3c 20                	cmp    $0x20,%al    ; Mitsumi command 20h: sub-Q candidate
...
; ---------------------------------------------------------------------------
; parse_option_H @ 0xF12A2
; Parses /H option. Probes INT 2Fh host/hardware service.
; ---------------------------------------------------------------------------
   f12a2:	06                   	push   %es
   f12a3:	52                   	push   %dx
   f12a4:	53                   	push   %bx
   f12a5:	c6 06 09 05 00       	movb   $0x0,0x509    ; driver var 0509h: /H host service mode
   f12aa:	b8 00 43             	mov    $0x4300,%ax
   f12ad:	cd 2f                	int    $0x2f    ; Multiplex INT 2Fh service
   f12af:	3c 80                	cmp    $0x80,%al
   f12b1:	75 42                	jne    0xf12f5
   f12b3:	b8 10 43             	mov    $0x4310,%ax
   f12b6:	cd 2f                	int    $0x2f    ; Multiplex INT 2Fh service
   f12b8:	89 1e 0a 05          	mov    %bx,0x50a    ; driver var 050Ah: /H host service ptr low
   f12bc:	8c 06 0c 05          	mov    %es,0x50c    ; driver var 050Ch: /H host service ptr segment
   f12c0:	33 d2                	xor    %dx,%dx
   f12c2:	32 e4                	xor    %ah,%ah
   f12c4:	a0 cb 00             	mov    0xcb,%al    ; driver var 00CBh: buffer count
   f12c7:	fe c0                	inc    %al
   ...
   f12d4:	ff 1e 0a 05          	lcall  *0x50a    ; driver var 050Ah: /H host service ptr low
   f12d8:	3d 01 00             	cmp    $0x1,%ax
   f12db:	74 02                	je     0xf12df
   f12dd:	eb 16                	jmp    0xf12f5
   f12df:	b4 03                	mov    $0x3,%ah
   f12e1:	ff 1e 0a 05          	lcall  *0x50a    ; driver var 050Ah: /H host service ptr low
   f12e5:	3d 01 00             	cmp    $0x1,%ax
   f12e8:	74 02                	je     0xf12ec
   f12ea:	eb 09                	jmp    0xf12f5
   f12ec:	c6 06 09 05 01       	movb   $0x1,0x509    ; driver var 0509h: /H host service mode
   f12f1:	5b                   	pop    %bx
   f12f2:	5a                   	pop    %dx
   f12f3:	07                   	pop    %es
   f12f4:	c3                   	ret
   f12f5:	c6 06 09 05 02       	movb   $0x2,0x509    ; driver var 0509h: /H host service mode
   f12fa:	5b                   	pop    %bx
   f12fb:	5a                   	pop    %dx
   f12fc:	07                   	pop    %es
   f12fd:	c3                   	ret
   ...
   f130d:	5d                   	pop    %bp
   f130e:	c3                   	ret
   f130f:	b8 40 00             	mov    $0x40,%ax    ; Mitsumi command 40h: status
   f1312:	8e c0                	mov    %ax,%es
   f1314:	bb 6c 00             	mov    $0x6c,%bx    ; driver var 006Ch: secondary MSF/count byte
...
; STRING @ 0xF1327, length 4: &;7u
   ...
   f142c:	cd 21                	int    $0x21    ; DOS INT 21h service
   f142e:	c3                   	ret
   f142f:	32 c0                	xor    %al,%al
   f1431:	b4 02                	mov    $0x2,%ah
   f1433:	cd 21                	int    $0x21    ; DOS INT 21h service
   f1435:	c3                   	ret
   f1436:	51                   	push   %cx
   f1437:	06                   	push   %es
...
; STRING @ 0xF1447, length 5: =DCtN
   ...
   f146c:	bb 10 00             	mov    $0x10,%bx    ; Mitsumi command 10h: TOC/disk info candidate
